...
pub fn ruby_tests_l56_d1_run(context DevTestsContext, args DevTestsArgs) !DevTestsRunPlan {
	return dev_tests_run(context, args)
}

// Ruby method `setup_environment!` at line 189.
pub fn ruby_tests_l189_d2_setup_environment(context DevTestsContext,
	args DevTestsArgs) DevTestsEnvironmentResult {
	return dev_tests_setup_environment(context, args)
}

// Ruby method `check_test_environment!; end` at line 261.
pub fn ruby_tests_l261_d3_check_test_environment() ! {
	dev_tests_check_test_environment()!
}

// Ruby method `changed_test_files` at line 264.
pub fn ruby_tests_l264_d4_changed_test_files(context DevTestsContext) []string {
	return dev_tests_changed_test_files(context)
}

// Ruby method `os_bundle_args(bundle_args)` at line 292.
pub fn ruby_tests_l292_d5_os_bundle_args(bundle_args []string, os_name string, ci bool,
	online bool) []string {
	return dev_tests_os_bundle_args(bundle_args, os_name, ci, online)
}

// Ruby method `non_macos_bundle_args(bundle_args)` at line 298.
pub fn ruby_tests_l298_d6_non_macos_bundle_args(bundle_args []string, ci bool,
	online bool) []string {
	return dev_tests_non_macos_bundle_args(bundle_args, ci, online)
}

// Ruby method `non_linux_bundle_args(bundle_args)` at line 307.
pub fn ruby_tests_l307_d7_non_linux_bundle_args(bundle_args []string) []string {
	return dev_tests_non_linux_bundle_args(bundle_args)
}

// Ruby method `os_files(files)` at line 312.
pub fn ruby_tests_l312_d8_os_files(files []string, os_name string) []string {
	return dev_tests_os_files(files, os_name)
}

// Ruby method `non_macos_files(files)` at line 318.
pub fn ruby_tests_l318_d9_non_macos_files(files []string) []string {
	return dev_tests_non_macos_files(files)
}

// Ruby method `non_linux_files(files)` at line 323.
pub fn ruby_tests_l323_d10_non_linux_files(files []string) []string {
	return dev_tests_non_linux_files(files)
}

// Ruby method `shared_context_test_files(filestub)` at line 328.
pub fn ruby_tests_l328_d11_shared_context_test_files(context DevTestsContext,
	filestub string) []string {
	return dev_tests_shared_context_test_files(context, filestub)
}

// Ruby method `tests_tagged_with(tag)` at line 340.
pub fn ruby_tests_l340_d12_tests_tagged_with(context DevTestsContext, tag string) []string {
	return dev_tests_tests_tagged_with(context, tag)
}

// Ruby method `file_uses_rspec_tag?(path, tag)` at line 351.
pub fn ruby_tests_l351_d13_file_uses_rspec_tag(content string, tag string) bool {
	return dev_tests_file_uses_rspec_tag(content, tag)
}
