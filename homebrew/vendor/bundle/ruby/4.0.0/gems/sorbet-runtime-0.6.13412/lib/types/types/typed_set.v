...
pub fn new_typed_set_type(type_value ruby.Value) &TypedEnumerableType {
	return new_typed_enumerable_subtype(type_value, 'Set', 'T::Set')
}

fn typed_set_value(type_value ruby.Value) ruby.Value {
	return typed_enumerable_value(new_typed_set_type(type_value))
}

pub fn typed_set_new(args []ruby.Value) !ruby.Value {
	if args.len == 0 {
		return ruby.Value{
			type_name: 'Set'
			repr: '#<Set: {}>'
...
pub fn ruby_typed_set_l11_d1_underlying_class(args ...ruby.Value) ruby.Value {
	typed_enumerable_from_args(args)
	return ruby.object_value('Class', 'Set')
}

// Ruby method `name` at line 16.
pub fn ruby_typed_set_l16_d2_name(args ...ruby.Value) ruby.Value {
	return ruby.string_value(typed_enumerable_from_args(args).name())
}

// Ruby method `recursively_valid?(obj)` at line 21.
pub fn ruby_typed_set_l21_d3_recursively_valid(args ...ruby.Value) ruby.Value {
	if args.len < 2 {
...
pub fn ruby_typed_set_l26_d4_valid(args ...ruby.Value) ruby.Value {
	if args.len < 2 {
		panic('TypedSet#valid? requires an object')
	}
	return ruby.bool_value(args[1].type_name == 'Set')
}

// Ruby method `new(...)` at line 30.
pub fn ruby_typed_set_l30_d5_new(args ...ruby.Value) ruby.Value {
	if args.len == 0 {
...
pub fn ruby_typed_set_l35_d6_initialize(args ...ruby.Value) ruby.Value {
	return typed_set_value(base_type_boundary_value(base_untyped_type()))
}

// Ruby method `valid?(obj)` at line 39.
pub fn ruby_typed_set_l39_d7_valid(args ...ruby.Value) ruby.Value {
	if args.len < 2 {
