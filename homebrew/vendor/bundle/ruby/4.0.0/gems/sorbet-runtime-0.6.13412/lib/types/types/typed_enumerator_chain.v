...
pub fn new_typed_enumerator_chain_type(type_value ruby.Value) &TypedEnumerableType {
	return new_typed_enumerable_subtype(type_value, 'Enumerator::Chain', 'T::Enumerator::Chain')
}

fn typed_enumerator_chain_value(type_value ruby.Value) ruby.Value {
	return typed_enumerable_value(new_typed_enumerator_chain_type(type_value))
}

// Ruby method `underlying_class` at line 6.
pub fn ruby_typed_enumerator_chain_l6_d1_underlying_class(args ...ruby.Value) ruby.Value {
	typed_enumerable_from_args(args)
	return ruby.object_value('Class', 'Enumerator::Chain')
}

// Ruby method `name` at line 11.
pub fn ruby_typed_enumerator_chain_l11_d2_name(args ...ruby.Value) ruby.Value {
	return ruby.string_value(typed_enumerable_from_args(args).name())
}

// Ruby method `recursively_valid?(obj)` at line 16.
pub fn ruby_typed_enumerator_chain_l16_d3_recursively_valid(args ...ruby.Value) ruby.Value {
	if args.len < 2 {
		panic('TypedEnumeratorChain#recursively_valid? requires an object')
	}
	return ruby.bool_value(args[1].type_name == 'Enumerator::Chain')
}

// Ruby method `valid?(obj)` at line 21.
pub fn ruby_typed_enumerator_chain_l21_d4_valid(args ...ruby.Value) ruby.Value {
	if args.len < 2 {
...
pub fn ruby_typed_enumerator_chain_l25_d5_new(args ...ruby.Value) ruby.Value {
	if args.len == 0 {
...
pub fn ruby_typed_enumerator_chain_l30_d6_initialize(args ...ruby.Value) ruby.Value {
	return typed_enumerator_chain_value(base_type_boundary_value(base_untyped_type()))
}

// Ruby method `valid?(obj)` at line 34.
pub fn ruby_typed_enumerator_chain_l34_d7_valid(args ...ruby.Value) ruby.Value {
	if args.len < 2 {
