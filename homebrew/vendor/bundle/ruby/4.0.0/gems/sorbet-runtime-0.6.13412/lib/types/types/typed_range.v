...
pub fn new_typed_range_type(type_value ruby.Value) &TypedEnumerableType {
	return new_typed_enumerable_subtype(type_value, 'Range', 'T::Range')
}

fn typed_range_value(type_value ruby.Value) ruby.Value {
	return typed_enumerable_value(new_typed_range_type(type_value))
}

pub fn typed_range_new(args []ruby.Value) !ruby.Value {
	if args.len < 2 {
...
pub fn ruby_typed_range_l6_d1_underlying_class(args ...ruby.Value) ruby.Value {
	typed_enumerable_from_args(args)
	return ruby.object_value('Class', 'Range')
}

// Ruby method `name` at line 11.
pub fn ruby_typed_range_l11_d2_name(args ...ruby.Value) ruby.Value {
	return ruby.string_value(typed_enumerable_from_args(args).name())
}

// Ruby method `recursively_valid?(obj)` at line 16.
pub fn ruby_typed_range_l16_d3_recursively_valid(args ...ruby.Value) ruby.Value {
	if args.len < 2 {
...
pub fn ruby_typed_range_l21_d4_valid(args ...ruby.Value) ruby.Value {
	if args.len < 2 {
		panic('TypedRange#valid? requires an object')
	}
	return ruby.bool_value(args[1].type_name == 'Range')
}

// Ruby method `new(...)` at line 25.
pub fn ruby_typed_range_l25_d5_new(args ...ruby.Value) ruby.Value {
	if args.len == 0 {
...
pub fn ruby_typed_range_l30_d6_initialize(args ...ruby.Value) ruby.Value {
	return typed_range_value(base_type_boundary_value(base_untyped_type()))
}

// Ruby method `valid?(obj)` at line 34.
pub fn ruby_typed_range_l34_d7_valid(args ...ruby.Value) ruby.Value {
	if args.len < 2 {
