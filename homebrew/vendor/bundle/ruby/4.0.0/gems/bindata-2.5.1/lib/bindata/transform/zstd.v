...
pub fn ruby_zstd_l11_d1_initialize(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('initialize', ...args)
}

// Ruby method `read(n)` at line 16.
pub fn ruby_zstd_l16_d2_read(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('read', ...args)
}

// Ruby method `write(data)` at line 21.
pub fn ruby_zstd_l21_d3_write(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('write', ...args)
}

// Ruby method `after_read_transform` at line 26.
pub fn ruby_zstd_l26_d4_after_read_transform(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('after_read_transform', ...args)
}

// Ruby method `after_write_transform` at line 30.
pub fn ruby_zstd_l30_d5_after_write_transform(args ...brew_runtime.Value) brew_runtime.Value {
