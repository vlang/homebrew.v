...
pub fn ruby_lzma_l11_d1_initialize(args ...ruby.Value) ruby.Value {
	if args.len == 0 {
...
pub fn ruby_lzma_l16_d2_read(args ...ruby.Value) ruby.Value {
	return translated_read(.xz, args)
}

// Ruby method `write(data)` at line 21.
pub fn ruby_lzma_l21_d3_write(args ...ruby.Value) ruby.Value {
	return translated_write(args)
}

// Ruby method `after_read_transform` at line 26.
pub fn ruby_lzma_l26_d4_after_read_transform(args ...ruby.Value) ruby.Value {
	return translated_after_read(args)
}

// Ruby method `after_write_transform` at line 30.
pub fn ruby_lzma_l30_d5_after_write_transform(args ...ruby.Value) ruby.Value {
