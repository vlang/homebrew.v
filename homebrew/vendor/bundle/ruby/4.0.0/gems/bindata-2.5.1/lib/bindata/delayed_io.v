...
pub type DelayedReadFn = fn(mut IORead) !ruby.Value

pub type DelayedWriteFn = fn(mut IOWrite, ruby.Value) !
...
fn delayed_nil_value() ruby.Value {
	return ruby.object_value('NilClass', 'nil')
}

fn instantiate_delayed_child(prototype ruby.Value, parent ruby.Value) ruby.Value {
...
pub fn new_bindata_delayed_io(parameters map[string]ruby.Value) &DelayedIOObject {
...
fn delayed_io_value(object &DelayedIOObject) ruby.Value {
	return ruby.Value{
...
pub fn delayed_io_boundary_value(object &DelayedIOObject) ruby.Value {
	return delayed_io_value(object)
}

fn delayed_io_from_value(value ruby.Value) &DelayedIOObject {
...
fn delayed_child_snapshot(object &DelayedIOObject) ruby.Value {
...
pub fn (mut object DelayedIOObject) read_now() !ruby.Value {
	...
	if object.has_reader {
		...
		object.child = ruby.string_value(object.read_io.readbytes(count)!.bytestr())
	}
	return object.child
}
...
fn sanitize_delayed_parameters(object_class ruby.Value, values map[string]ruby.Value) !map[string]ruby.Value {
...
fn auto_delayed_values(receiver ruby.Value) []ruby.Value {
	value := ruby_base_l257_d35_top_level_get(receiver, ruby.object_value('Symbol', ':delayed_ios'))
...
pub fn ruby_delayed_io_l63_d1_initialize_instance(args ...ruby.Value) ruby.Value {
...
pub fn ruby_delayed_io_l70_d2_clear(args ...ruby.Value) ruby.Value {
...
pub fn ruby_delayed_io_l74_d3_assign(args ...ruby.Value) ruby.Value {
...
pub fn ruby_delayed_io_l78_d4_snapshot(args ...ruby.Value) ruby.Value {
	return delayed_child_snapshot(delayed_io_from_value(args[0]))
}

// Ruby method `num_bytes` at line 82.
pub fn ruby_delayed_io_l82_d5_num_bytes(args ...ruby.Value) ruby.Value {
	return ruby.int_value(delayed_child_num_bytes(delayed_io_from_value(args[0])))
}

// Ruby method `respond_to_missing?(symbol, include_all = false) # :nodoc:` at line 86.
pub fn ruby_delayed_io_l86_d6_respond_to_missing(args ...ruby.Value) ruby.Value {
	if args.len < 2 { panic('DelayedIO#respond_to_missing? requires symbol') }
	object := delayed_io_from_value(args[0])
	return ruby.bool_value(args[1].as_string().trim_left(':') in (object.child.attributes['method_names'] or { '' }).split(','))
}

// Ruby method `method_missing(symbol, *args, &block) # :nodoc:` at line 90.
pub fn ruby_delayed_io_l90_d7_method_missing(args ...ruby.Value) ruby.Value {
...
pub fn ruby_delayed_io_l94_d8_abs_offset(args ...ruby.Value) ruby.Value {
	return ruby.int_value(delayed_offset(delayed_io_from_value(args[0])))
}

// Ruby method `abs_offset=(offset)` at line 99.
pub fn ruby_delayed_io_l99_d9_abs_offset(args ...ruby.Value) ruby.Value {
...
pub fn ruby_delayed_io_l103_d10_rel_offset(args ...ruby.Value) ruby.Value {
	return ruby_delayed_io_l94_d8_abs_offset(...args)
}

// Ruby method `do_read(io) # :nodoc:` at line 107.
pub fn ruby_delayed_io_l107_d11_do_read(args ...ruby.Value) ruby.Value {
...
pub fn ruby_delayed_io_l111_d12_do_write(args ...ruby.Value) ruby.Value {
...
pub fn ruby_delayed_io_l115_d13_do_num_bytes(args ...ruby.Value) ruby.Value {
	return ruby.int_value(0)
}

// Ruby method `include_obj?` at line 119.
pub fn ruby_delayed_io_l119_d14_include_obj(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(delayed_include(delayed_io_from_value(args[0])))
}

// Ruby method `read_now!` at line 125.
pub fn ruby_delayed_io_l125_d15_read_now(args ...ruby.Value) ruby.Value {
	mut object := delayed_io_from_value(args[0])
	return object.read_now() or { panic(err) }
}

// Ruby method `write_now!` at line 137.
pub fn ruby_delayed_io_l137_d16_write_now(args ...ruby.Value) ruby.Value {
	mut object := delayed_io_from_value(args[0])
...
pub fn ruby_delayed_io_l149_d17_sanitize_parameters(args ...ruby.Value) ruby.Value {
	...
	return ruby.map_value(sanitize_delayed_parameters(object_class, params.as_map() or { panic(err) }) or { panic(err) })
}

// Ruby method `auto_call_delayed_io` at line 161.
pub fn ruby_delayed_io_l161_d18_auto_call_delayed_io(args ...ruby.Value) ruby.Value {
	if args.len == 0 {
		return ruby.object_value('Module', 'BinData::AutoCallDelayedIO')
	}
	mut attributes := args[0].attributes.clone()
	attributes['auto_call_delayed_io'] = 'true'
	return ruby.Value{ ...args[0], attributes: attributes }
}

// Ruby alias_method `DelayedIO.send(:alias_method, :initialize_instance_without_record_io, :initialize_instance)` at line 166.
pub fn ruby_delayed_io_l166_d19_initialize_instance_without_record_io(args ...ruby.Value) ruby.Value {
...
pub fn ruby_delayed_io_l167_d20_initialize_instance(args ...ruby.Value) ruby.Value {
	if args.len == 0 { panic('DelayedIO#initialize_instance requires receiver') }
	object := delayed_io_from_value(args[0])
	if object.base.has_parent {
		...
		if !values.any(it.attributes['delayed_io_address'] == args[0].attributes['delayed_io_address']) {
			values << args[0]
			ruby_base_l253_d34_top_level_set(args[0], ruby.object_value('Symbol', ':delayed_ios'), ruby.array_value(values))
		}
	}
...
pub fn ruby_delayed_io_l180_d21_initialize_shared_instance(args ...ruby.Value) ruby.Value {
	if args.len == 0 { panic('AutoCallDelayedIO#initialize_shared_instance requires receiver') }
	ruby_base_l253_d34_top_level_set(args[0], ruby.object_value('Symbol', ':delayed_ios'), ruby.array_value([]))
	return args[0]
}

// Ruby method `read(io)` at line 185.
pub fn ruby_delayed_io_l185_d22_read(args ...ruby.Value) ruby.Value {
...
pub fn ruby_delayed_io_l189_d23_write(args ...ruby.Value) ruby.Value {
...
pub fn ruby_delayed_io_l193_d24_num_bytes(args ...ruby.Value) ruby.Value {
	return ruby.int_value(ruby_base_l174_d19_to_binary_s(...args).as_string().len)
}
