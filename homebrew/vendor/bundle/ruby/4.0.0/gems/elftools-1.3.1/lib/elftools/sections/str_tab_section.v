...
pub fn ruby_str_tab_section_l16_d1_name_at(args ...ruby.Value) ruby.Value {
	...
	return ruby.string_value(string_table_name_at(args[0].as_string().bytes(), section_offset, offset) or { panic(err) })
}
