...
pub fn non_concurrent_priority_queue_from_list(list []ruby.Value, order PriorityQueueOrder) !NonConcurrentPriorityQueue {
...
pub fn (mut queue NonConcurrentPriorityQueue) delete(item ruby.Value) bool {
...
pub fn (queue &NonConcurrentPriorityQueue) include(item ruby.Value) bool {
...
pub fn (queue &NonConcurrentPriorityQueue) peek() ruby.Value {
	return queue.queue.peek()
}

pub fn (mut queue NonConcurrentPriorityQueue) pop() ruby.Value {
	return queue.queue.pop()
}

pub fn (mut queue NonConcurrentPriorityQueue) push(item ruby.Value) !bool {
	return queue.queue.push(item)
}

// Ruby alias_method `alias_method :has_priority?, :include?` at line 52.
pub fn ruby_non_concurrent_priority_queue_l52_d1_has_priority(args ...ruby.Value) ruby.Value {
	return ruby_ruby_non_concurrent_priority_queue_l48_d5_include(...args)
}

// Ruby alias_method `alias_method :size, :length` at line 54.
pub fn ruby_non_concurrent_priority_queue_l54_d2_size(args ...ruby.Value) ruby.Value {
	return ruby_ruby_non_concurrent_priority_queue_l54_d7_length(...args)
}

// Ruby alias_method `alias_method :deq, :pop` at line 56.
pub fn ruby_non_concurrent_priority_queue_l56_d3_deq(args ...ruby.Value) ruby.Value {
	return ruby_ruby_non_concurrent_priority_queue_l65_d10_pop(...args)
}

// Ruby alias_method `alias_method :shift, :pop` at line 57.
pub fn ruby_non_concurrent_priority_queue_l57_d4_shift(args ...ruby.Value) ruby.Value {
	return ruby_ruby_non_concurrent_priority_queue_l65_d10_pop(...args)
}

// Ruby alias_method `alias_method :<<, :push` at line 59.
pub fn ruby_non_concurrent_priority_queue_l59_d5_push(args ...ruby.Value) ruby.Value {
	return ruby_ruby_non_concurrent_priority_queue_l78_d13_push(...args)
}

// Ruby alias_method `alias_method :enq, :push` at line 60.
pub fn ruby_non_concurrent_priority_queue_l60_d6_enq(args ...ruby.Value) ruby.Value {
	return ruby_ruby_non_concurrent_priority_queue_l78_d13_push(...args)
}
