...
pub fn ruby_formula_struct_generator_l43_d1_generate_formula_struct_hash(hash map[string]ruby.Value,
	options FormulaStructGeneratorOptions) !api.FormulaStruct {
...
pub fn ruby_formula_struct_generator_l203_d2_process_dependencies_and_requirements(deps_hash ?map[string]ruby.Value,
	requirements_array ?[]ruby.Value, spec string) FormulaDependenciesResult {
...
pub fn ruby_formula_struct_generator_l223_d3_symbolize_dependency_hash(hash map[string]ruby.Value) map[string]ruby.Value {
	return formula_generator_symbolize_dependency_hash(hash)
}

// Ruby method `process_dependencies(deps_hash)` at line 251.
pub fn ruby_formula_struct_generator_l251_d4_process_dependencies(deps_hash map[string]ruby.Value) []ruby.Value {
...
pub fn ruby_formula_struct_generator_l261_d5_process_requirements(requirements_array []ruby.Value,
	spec string) []ruby.Value {
...
pub fn ruby_formula_struct_generator_l299_d6_process_uses_from_macos(deps_hash map[string]ruby.Value) []api.ApiStructArgPair {
