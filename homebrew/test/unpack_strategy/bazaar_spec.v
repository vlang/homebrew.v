...
pub fn ruby_bazaar_spec_l7_d1_repo(args ...ruby.Value) ruby.Value {
	return ruby.string_value(spec_repository_fixture('bazaar', '.bzr', true))
}

// Ruby let `let(:path) { repo }` at line 13.
pub fn ruby_bazaar_spec_l13_d2_path(args ...ruby.Value) ruby.Value {
