...
pub fn ruby_zstd_spec_l7_d1_path(args ...brew_runtime.Value) brew_runtime.Value {
	path := os.join_path(spec_temp_dir('zstd'), 'container.tar.zst')
	return brew_runtime.string_value(spec_write_bytes(path, [u8(0x28), 0xb5, 0x2f, 0xfd]))
}

// Ruby it `it "is correctly detected" do` at line 9.
pub fn ruby_zstd_spec_l9_d2_is(args ...brew_runtime.Value) brew_runtime.Value {
