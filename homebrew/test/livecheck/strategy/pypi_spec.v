...
pub fn ruby_pypi_spec_l7_d1_pypi(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('pypi', ...args)
}

// Ruby let `let(:pypi_url) { "https://files.pythonhosted.org/packages/ab/cd/efg/example-package-1.2.3.tar.gz" }` at line 9.
pub fn ruby_pypi_spec_l9_d2_pypi_url(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('pypi_url', ...args)
}

// Ruby let `let(:non_pypi_url) { "https://brew.sh/test" }` at line 10.
pub fn ruby_pypi_spec_l10_d3_non_pypi_url(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('non_pypi_url', ...args)
}

// Ruby let `let(:regex) { /^v?(\d+(?:\.\d+)+)/i }` at line 11.
pub fn ruby_pypi_spec_l11_d4_regex(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('regex', ...args)
}

// Ruby let `let(:generated) do` at line 12.
pub fn ruby_pypi_spec_l12_d5_generated(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('generated', ...args)
}

// Ruby let `let(:content) do` at line 20.
pub fn ruby_pypi_spec_l20_d6_content(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('content', ...args)
}

// Ruby let `let(:matches) { ["1.2.3-456"] }` at line 29.
pub fn ruby_pypi_spec_l29_d7_matches(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('matches', ...args)
}

// Ruby it `it "returns true for a PyPI URL" do` at line 32.
pub fn ruby_pypi_spec_l32_d8_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('returns', ...args)
}

// Ruby it `it "returns false for a non-PyPI URL" do` at line 36.
pub fn ruby_pypi_spec_l36_d9_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('returns', ...args)
}

// Ruby it `it "returns a hash containing url and regex for an PyPI URL" do` at line 42.
pub fn ruby_pypi_spec_l42_d10_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('returns', ...args)
}

// Ruby it `it "returns an empty hash for a non-PyPI URL" do` at line 46.
pub fn ruby_pypi_spec_l46_d11_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('returns', ...args)
}

// Ruby let `let(:match_data) do` at line 52.
pub fn ruby_pypi_spec_l52_d12_match_data(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('match_data', ...args)
}

// Ruby it `it "finds versions in provided content" do` at line 70.
pub fn ruby_pypi_spec_l70_d13_finds(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('finds', ...args)
}

// Ruby it `it "finds versions in provided content using a block" do` at line 78.
pub fn ruby_pypi_spec_l78_d14_finds(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('finds', ...args)
}

// Ruby it `it "returns default match_data when block doesn't return version information" do` at line 93.
pub fn ruby_pypi_spec_l93_d15_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('returns', ...args)
}

// Ruby it `it "returns default match_data when url is blank" do` at line 104.
pub fn ruby_pypi_spec_l104_d16_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('returns', ...args)
}

// Ruby it `it "returns default match_data when content is blank" do` at line 109.
pub fn ruby_pypi_spec_l109_d17_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('returns', ...args)
}
