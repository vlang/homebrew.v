...
pub fn ruby_shell_completion_spec_l8_d1_returns(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(brew_utils.default_completion_shells('') == [
		'bash',
		'zsh',
		'fish',
	])
...
pub fn ruby_shell_completion_spec_l12_d2_returns(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(brew_utils.default_completion_shells('unknown') == [
		'bash',
		'zsh',
		'fish',
	])
...
pub fn ruby_shell_completion_spec_l16_d3_includes(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(brew_utils.default_completion_shells('cobra') == [
		'bash',
		'zsh',
		'fish',
		'pwsh',
...
pub fn ruby_shell_completion_spec_l20_d4_includes(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(brew_utils.default_completion_shells('typer') == [
		'bash',
		'zsh',
		'fish',
		'pwsh',
...
pub fn ruby_shell_completion_spec_l48_d10_returns(args ...ruby.Value) ruby.Value {
	result := brew_utils.completion_shell_parameter('cobra', 'zsh', '/usr/bin/foo', {})
	return ruby.bool_value(result.arguments == ['completion', 'zsh'])
}

// Ruby it `it "returns --<shell> for :flag format" do` at line 53.
pub fn ruby_shell_completion_spec_l53_d11_returns(args ...ruby.Value) ruby.Value {
	result := brew_utils.completion_shell_parameter('flag', 'fish', '/usr/bin/foo', {})
	return ruby.bool_value(result.arguments == ['--fish'])
}

// Ruby it `it "returns nil for :none format" do` at line 57.
pub fn ruby_shell_completion_spec_l57_d12_returns(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(brew_utils.completion_shell_parameter('none', 'bash',
		'/usr/bin/foo', {}).arguments.len == 0)
}

// Ruby it `it "returns subcommand array for :typer format and sets env" do` at line 61.
pub fn ruby_shell_completion_spec_l61_d13_returns(args ...ruby.Value) ruby.Value {
	result := brew_utils.completion_shell_parameter('typer', 'bash', '/usr/bin/foo', {})
	return ruby.bool_value(result.arguments == ['--show-completion', 'bash']
		&& result.environment['_TYPER_COMPLETE_TEST_DISABLE_SHELL_DETECTION'] == '1')
}

// Ruby it `it "maps :pwsh to 'powershell'" do` at line 67.
pub fn ruby_shell_completion_spec_l67_d14_maps(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(brew_utils.completion_shell_parameter('', 'pwsh',
		'/usr/bin/foo', {}).arguments == ['powershell'])
}

// Ruby it `it "interpolates custom format string" do` at line 71.
pub fn ruby_shell_completion_spec_l71_d15_interpolates(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(brew_utils.completion_shell_parameter('--complete-', 'zsh',
		'/usr/bin/foo', {}).arguments == ['--complete-zsh'])
}

// Ruby it `it "calls safe_popen_read with commands and shell parameter" do` at line 78.
pub fn ruby_shell_completion_spec_l78_d16_calls(args ...ruby.Value) ruby.Value {
