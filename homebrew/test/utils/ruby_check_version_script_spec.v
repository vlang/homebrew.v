...
pub fn ruby_ruby_check_version_script_spec_l6_d1_subject_dynamic(args ...ruby.Value) ruby.Value {
	...
	return ruby.bool_value(brew_utils.check_ruby_version(running, required, developer, use_path))
}

// Ruby let `let(:required_ruby_version) { "1.2.3" }` at line 17.
pub fn ruby_ruby_check_version_script_spec_l17_d2_required_ruby_version(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.string_value('1.2.3')
}

// Ruby let `let(:required_ruby_version) { RUBY_VERSION }` at line 25.
pub fn ruby_ruby_check_version_script_spec_l25_d3_required_ruby_version(args ...ruby.Value) ruby.Value {
	return ruby.string_value(if args.len > 0 { args[0].as_string() } else { '3.4.5' })
}

// Ruby it `it { is_expected.to be true }` at line 27.
pub fn ruby_ruby_check_version_script_spec_l27_d4_anonymous(args ...ruby.Value) ruby.Value {
	running := if args.len > 0 { args[0].as_string() } else { '3.4.5' }
	return ruby.bool_value(brew_utils.check_ruby_version(running, running, false, false))
}

// Ruby let `let(:required_ruby_version) { "2.0.0" }` at line 31.
pub fn ruby_ruby_check_version_script_spec_l31_d5_required_ruby_version(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.string_value('2.0.0')
}

// Ruby it `it { is_expected.to be true }` at line 38.
pub fn ruby_ruby_check_version_script_spec_l38_d6_anonymous(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.bool_value(brew_utils.check_ruby_version('3.4.5', '2.0.0', true, true))
}

// Ruby let `let(:required_ruby_version) { "1.2.3" }` at line 42.
pub fn ruby_ruby_check_version_script_spec_l42_d7_required_ruby_version(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.string_value('1.2.3')
}

// Ruby it `it { is_expected.to be false }` at line 44.
pub fn ruby_ruby_check_version_script_spec_l44_d8_anonymous(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.bool_value(!brew_utils.check_ruby_version('3.4.5', '1.2.3', false, false))
}

// Ruby let `let(:required_ruby_version) { "fish" }` at line 48.
pub fn ruby_ruby_check_version_script_spec_l48_d9_required_ruby_version(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.string_value('fish')
}

// Ruby it `it { is_expected.to be false }` at line 50.
pub fn ruby_ruby_check_version_script_spec_l50_d10_anonymous(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.bool_value(!brew_utils.check_ruby_version('3.4.5', 'fish', false, false))
}
