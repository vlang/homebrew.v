...
pub fn ruby_shell_spec_l8_d1_returns(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_shell_spec_l13_d2_returns(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_shell_spec_l18_d3_returns(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_shell_spec_l23_d4_returns(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_shell_spec_l29_d5_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return shell_spec_bool(shell_utils.shell_profile_for('zsh', '/home/test', '') == '~/.zshrc')
}

// Ruby it `it "returns ~/.kshrc for Ksh" do` at line 35.
pub fn ruby_shell_spec_l35_d6_returns(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_shell_spec_l40_d7_returns(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_shell_spec_l70_d13_sh_quote(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_shell_spec_l78_d14_csh_quote(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_shell_spec_l88_d15_path(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.string_value('/my/path')
}

// Ruby it `it "supports tcsh" do` at line 90.
pub fn ruby_shell_spec_l90_d16_supports(args ...brew_runtime.Value) brew_runtime.Value {
	profile := '~/.tcshrc'
...
pub fn ruby_shell_spec_l96_d17_supports(args ...brew_runtime.Value) brew_runtime.Value {
	profile := '~/.profile'
...
pub fn ruby_shell_spec_l102_d18_supports(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_shell_spec_l111_d19_supports(args ...brew_runtime.Value) brew_runtime.Value {
	profile := '~/.kshrc'
...
pub fn ruby_shell_spec_l119_d20_home(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.string_value(os.temp_dir())
}

// Ruby let `let(:notice) { "" }` at line 120.
pub fn ruby_shell_spec_l120_d21_notice(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.string_value('')
}

// Ruby let `let(:prompt) { "test" }` at line 121.
pub fn ruby_shell_spec_l121_d22_prompt(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.string_value('test')
}

// Ruby let `let(:path) { "/some/path" }` at line 122.
pub fn ruby_shell_spec_l122_d23_path(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.string_value('/some/path')
}

// Ruby it `it "returns zsh-specific prompt configuration" do` at line 124.
pub fn ruby_shell_spec_l124_d24_returns(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_shell_spec_l133_d25_returns(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_shell_spec_l142_d26_returns(args ...brew_runtime.Value) brew_runtime.Value {
	plan := shell_utils.shell_prompt_plan('test', shell_utils.ShellPromptOptions{
...
pub fn ruby_shell_spec_l149_d27_outputs(args ...brew_runtime.Value) brew_runtime.Value {
	plan := shell_utils.shell_prompt_plan('test', shell_utils.ShellPromptOptions{
		preferred_path: '/bin/bash'
		path: '/some/path'
...
fn shell_spec_bool(value bool) brew_runtime.Value {
