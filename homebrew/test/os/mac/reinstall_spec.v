...
pub fn ruby_reinstall_spec_l9_d1_formula(args ...ruby.Value) ruby.Value {
...
pub fn ruby_reinstall_spec_l10_d2_formula_installer(args ...ruby.Value) ruby.Value {
...
pub fn ruby_reinstall_spec_l13_d3_context(args ...ruby.Value) ruby.Value {
...
pub fn ruby_reinstall_spec_l22_d4_does(args ...ruby.Value) ruby.Value {
	result := reinstall_mac.mac_reinstall_pkgconf_if_needed(reinstall_mac.mac_pkgconf_reinstall_fixture('', 'warning', false), false)
	return ruby.bool_value(!result.mismatch_found && !result.reinstalled && result.warnings.len == 0)
}

// Ruby it `it "prints a warning and does not reinstall" do` at line 31.
pub fn ruby_reinstall_spec_l31_d5_prints(args ...ruby.Value) ruby.Value {
	...
	return ruby.bool_value(result.dry_run && !result.reinstalled && result.warnings.len == 1 && result.warnings[0].contains('would be reinstalled'))
}

// Ruby it `it "reinstalls pkgconf and prints success" do` at line 44.
pub fn ruby_reinstall_spec_l44_d6_reinstalls(args ...ruby.Value) ruby.Value {
	...
	return ruby.bool_value(result.reinstalled && result.infos.len == 1 && result.infos[0].contains('Reinstalled pkgconf'))
}

// Ruby it `it "rescues and prints the mismatch warning" do` at line 54.
pub fn ruby_reinstall_spec_l54_d7_rescues(args ...ruby.Value) ruby.Value {
