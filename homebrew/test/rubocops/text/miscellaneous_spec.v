...
pub fn ruby_miscellaneous_spec_l7_d1_cop(args ...ruby.Value) ruby.Value {
	return ruby.object_value('RuboCop::Cop::FormulaAudit::Miscellaneous', 'Miscellaneous')
}

// Ruby it `it "reports an offense for unneeded `FileUtils` usage" do` at line 10.
pub fn ruby_miscellaneous_spec_l10_d2_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('FileUtils.mv "hello"', [
		'No need for `FileUtils.` before `mv`',
	]))
}

// Ruby it `it "reports an offense for long `inreplace` block variable names" do` at line 21.
pub fn ruby_miscellaneous_spec_l21_d3_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('inreplace "foo" do |longvar|\n  somerandomCall(longvar)\nend', [
...
pub fn ruby_miscellaneous_spec_l34_d4_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('bottle do\n  rebuild 0\n  sha256 "fe0679b932dd43a87fd415b609a7fbac7a069d117642ae8ebaac46ae1fb9f0b3" => :sonoma\nend', [
		'`rebuild 0` should be removed',
	]))
}

// Ruby it `it "reports an offense when a useless `fails_with :llvm` is used" do` at line 48.
pub fn ruby_miscellaneous_spec_l48_d5_reports(args ...ruby.Value) ruby.Value {
	body := 'bottle do\n  sha256 "fe0679b932dd43a87fd415b609a7fbac7a069d117642ae8ebaac46ae1fb9f0b3" => :sonoma\nend\nfails_with :llvm do\n  build 2335\n  cause "foo"\nend'
	return ruby.bool_value(miscellaneous_spec_reports(body, [
		'`fails_with :llvm` is now a no-op and should be removed',
	]))
}

// Ruby it `it "reports an offense when `def test` is used" do` at line 65.
pub fn ruby_miscellaneous_spec_l65_d6_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('def test\n  assert_equals "1", "1"\nend', [
		'Use new-style test definitions (`test do`)',
	]))
}

// Ruby method `test` at line 71.
pub fn ruby_miscellaneous_spec_l71_d7_test(args ...ruby.Value) ruby.Value {
	return ruby.string_value('def test\n  assert_equals "1", "1"\nend')
}

// Ruby it `it "reports an offense when `skip_clean` is used" do` at line 79.
pub fn ruby_miscellaneous_spec_l79_d8_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('skip_clean :all', [
...
pub fn ruby_miscellaneous_spec_l90_d9_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('system "install_name_tool", "-id"', [
...
pub fn ruby_miscellaneous_spec_l101_d10_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('depends_on FOO::BAR.new', [
...
pub fn ruby_miscellaneous_spec_l112_d11_reports(args ...ruby.Value) ruby.Value {
...
pub fn ruby_miscellaneous_spec_l124_d12_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('system "mkdir", "foo"', [
...
pub fn ruby_miscellaneous_spec_l135_d13_reports(args ...ruby.Value) ruby.Value {
	source := 'def test\n   nil\nend\nclass Foo < Formula\n  desc "foo"\n  url \'https://brew.sh/foo-1.0.tgz\'\nend'
	return ruby.bool_value(miscellaneous_spec_reports_source(source, [
		'Define method `test` in the class body, not at the top-level',
	]))
}

// Ruby method `test` at line 137.
pub fn ruby_miscellaneous_spec_l137_d14_test(args ...ruby.Value) ruby.Value {
	return ruby.string_value('def test\n   nil\nend')
}

// Ruby it `it 'reports an offense when `man+"man8"` is used' do` at line 148.
pub fn ruby_miscellaneous_spec_l148_d15_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('def install\n  man1.install man+"man8" => "faad.1"\nend', [
		'`man+"man8"` should be `man8`',
	]))
}

// Ruby method `install` at line 153.
pub fn ruby_miscellaneous_spec_l153_d16_install(args ...ruby.Value) ruby.Value {
	return ruby.string_value('def install\n  man1.install man+"man8" => "faad.1"\nend')
}

// Ruby it `it "reports an offense when a hard-coded `gcc` is referenced" do` at line 161.
pub fn ruby_miscellaneous_spec_l161_d17_reports(args ...ruby.Value) ruby.Value {
...
pub fn ruby_miscellaneous_spec_l166_d18_install(args ...ruby.Value) ruby.Value {
	return ruby.string_value('def install\n  system "/usr/bin/gcc", "foo"\nend')
}

// Ruby it `it "reports an offense when a hard-coded `g++` is referenced" do` at line 174.
pub fn ruby_miscellaneous_spec_l174_d19_reports(args ...ruby.Value) ruby.Value {
...
pub fn ruby_miscellaneous_spec_l179_d20_install(args ...ruby.Value) ruby.Value {
	return ruby.string_value('def install\n  system "/usr/bin/g++", "-o", "foo", "foo.cc"\nend')
}

// Ruby it `it "reports an offense when a hard-coded `c++` is set as COMPILER_PATH" do` at line 187.
pub fn ruby_miscellaneous_spec_l187_d21_reports(args ...ruby.Value) ruby.Value {
...
pub fn ruby_miscellaneous_spec_l192_d22_install(args ...ruby.Value) ruby.Value {
	return ruby.string_value('def install\n  ENV["COMPILER_PATH"] = "/usr/bin/c++"\nend')
}

// Ruby it `it "reports an offense when a hard-coded `gcc` is set as COMPILER_PATH" do` at line 200.
pub fn ruby_miscellaneous_spec_l200_d23_reports(args ...ruby.Value) ruby.Value {
...
pub fn ruby_miscellaneous_spec_l205_d24_install(args ...ruby.Value) ruby.Value {
	return ruby.string_value('def install\n  ENV["COMPILER_PATH"] = "/usr/bin/gcc"\nend')
}

// Ruby it `it "reports an offense when the formula path shortcut `man` could be used" do` at line 213.
pub fn ruby_miscellaneous_spec_l213_d25_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('def install\n  mv "#{share}/man", share\nend', [
...
pub fn ruby_miscellaneous_spec_l218_d26_install(args ...ruby.Value) ruby.Value {
	return ruby.string_value('def install\n  mv "#{share}/man", share\nend')
}

// Ruby it `it "reports an offense when the formula path shortcut `libexec` could be used" do` at line 226.
pub fn ruby_miscellaneous_spec_l226_d27_reports(args ...ruby.Value) ruby.Value {
...
pub fn ruby_miscellaneous_spec_l231_d28_install(args ...ruby.Value) ruby.Value {
	return ruby.string_value('def install\n  mv "#{prefix}/libexec", share\nend')
}

// Ruby it `it "reports an offense when the formula path shortcut `info` could be used" do` at line 239.
pub fn ruby_miscellaneous_spec_l239_d29_reports(args ...ruby.Value) ruby.Value {
...
pub fn ruby_miscellaneous_spec_l244_d30_install(args ...ruby.Value) ruby.Value {
	return ruby.string_value('def install\n  system "./configure", "--INFODIR=#{prefix}/share/info"\nend')
}

// Ruby it `it "reports an offense when the formula path shortcut `man8` could be used" do` at line 252.
pub fn ruby_miscellaneous_spec_l252_d31_reports(args ...ruby.Value) ruby.Value {
...
pub fn ruby_miscellaneous_spec_l257_d32_install(args ...ruby.Value) ruby.Value {
	return ruby.string_value('def install\n  system "./configure", "--MANDIR=#{prefix}/share/man/man8"\nend')
}

// Ruby it `it "reports an offense when unvendored lua modules are used" do` at line 265.
pub fn ruby_miscellaneous_spec_l265_d33_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('depends_on "lpeg" => :lua51', [
...
pub fn ruby_miscellaneous_spec_l276_d34_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('system "export", "var=value"', [
...
pub fn ruby_miscellaneous_spec_l287_d35_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('depends_on "foo" => "with-bar"', [
...
pub fn ruby_miscellaneous_spec_l298_d36_reports(args ...ruby.Value) ruby.Value {
...
pub fn ruby_miscellaneous_spec_l312_d37_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('if version == "HEAD"\n  foo()\nend', [
		'Use `build.head?` instead of inspecting `version`',
	]))
}

// Ruby it `it "reports an offense when `ARGV.include? (--HEAD)` is used" do` at line 325.
pub fn ruby_miscellaneous_spec_l325_d38_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('test do\n  head = ARGV.include? "--HEAD"\nend', [
...
pub fn ruby_miscellaneous_spec_l339_d39_reports(args ...ruby.Value) ruby.Value {
	return ruby.bool_value(miscellaneous_spec_reports('needs :openmp', [
...
pub fn ruby_miscellaneous_spec_l350_d40_reports(args ...ruby.Value) ruby.Value {
...
pub fn ruby_miscellaneous_spec_l363_d41_reports(args ...ruby.Value) ruby.Value {
	statement := 'depends_on "foo" if build.with? "foo"'
	return ruby.bool_value(miscellaneous_spec_reports(statement, [
...
pub fn ruby_miscellaneous_spec_l374_d42_reports(args ...ruby.Value) ruby.Value {
...
pub fn ruby_miscellaneous_spec_l385_d43_reports(args ...ruby.Value) ruby.Value {
