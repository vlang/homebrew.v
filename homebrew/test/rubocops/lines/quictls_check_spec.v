...
pub fn ruby_quictls_check_spec_l7_d1_cop(args ...ruby.Value) ruby.Value {
	return ruby.object_value('RuboCop::Cop::FormulaAudit::QuicTLSCheck', 'QuicTLSCheck')
}

// Ruby it `it "reports an offense when a formula depends on `quictls`" do` at line 10.
pub fn ruby_quictls_check_spec_l10_d2_reports(args ...ruby.Value) ruby.Value {
	...
	return ruby.bool_value(analysis.offenses.len == 1 && analysis.corrected == 'depends_on "openssl@3"' && analysis.offenses[0].message == 'Formulae in homebrew/core should use `depends_on "openssl@3"` instead of `depends_on "quictls"`.')
}
