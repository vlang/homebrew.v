...
pub fn ruby_class_inheritance_spec_l7_d1_cop(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.object_value('RuboCop::Cop::FormulaAudit::ClassInheritance', 'ClassInheritance')
}
...
pub fn ruby_class_inheritance_spec_l10_d2_reports(args ...brew_runtime.Value) brew_runtime.Value {
	...
	return brew_runtime.bool_value(analysis.offenses.len == 1 && analysis.offenses[0].message == 'Use a space in class inheritance: class Foo < Formula')
}
