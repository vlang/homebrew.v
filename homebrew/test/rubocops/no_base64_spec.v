...
pub fn ruby_no_base64_spec_l7_d1_registers(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_no_base64_spec_l19_d2_registers(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('registers', ...args)
}

// Ruby it `it "registers an offense and corrects `Base64.decode64`" do` at line 31.
pub fn ruby_no_base64_spec_l31_d3_registers(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('registers', ...args)
}

// Ruby it `it "registers an offense and corrects `Base64.strict_decode64`" do` at line 42.
pub fn ruby_no_base64_spec_l42_d4_registers(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('registers', ...args)
}

// Ruby it `it "registers an offense and corrects `Base64.encode64`" do` at line 53.
pub fn ruby_no_base64_spec_l53_d5_registers(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('registers', ...args)
}

// Ruby it `it "registers an offense and corrects `Base64.strict_encode64`" do` at line 64.
pub fn ruby_no_base64_spec_l64_d6_registers(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('registers', ...args)
}

// Ruby it `it "registers an offense and corrects `::Base64` calls" do` at line 75.
pub fn ruby_no_base64_spec_l75_d7_registers(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('registers', ...args)
}

// Ruby it `it "registers an offense without correction for other `Base64` methods" do` at line 86.
pub fn ruby_no_base64_spec_l86_d8_registers(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('registers', ...args)
}

// Ruby it `it "registers an offense without correction for a decode of a compound expression" do` at line 95.
pub fn ruby_no_base64_spec_l95_d9_registers(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('registers', ...args)
}

// Ruby it `it "registers an offense without correction for a bare `Base64` reference" do` at line 104.
pub fn ruby_no_base64_spec_l104_d10_registers(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('registers', ...args)
}

// Ruby it `it "does not register an offense for a formula class named `Base64`" do` at line 113.
pub fn ruby_no_base64_spec_l113_d11_does(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('does', ...args)
}

// Ruby it `it "does not register an offense for namespaced `Base64` constants" do` at line 121.
pub fn ruby_no_base64_spec_l121_d12_does(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('does', ...args)
}

// Ruby it `it "does not register an offense for other requires" do` at line 127.
pub fn ruby_no_base64_spec_l127_d13_does(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('does', ...args)
}
