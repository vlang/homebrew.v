...
pub fn ruby_bottle_order_spec_l7_d1_cop(args ...ruby.Value) ruby.Value {
	return ruby.object_value('RuboCop::Cop::FormulaAudit::BottleOrder', 'FormulaAudit/BottleOrder')
}
