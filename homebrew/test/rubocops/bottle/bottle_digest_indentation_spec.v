...
pub fn ruby_bottle_digest_indentation_spec_l7_d1_cop(args ...ruby.Value) ruby.Value {
	return ruby.object_value('RuboCop::Cop::FormulaAudit::BottleDigestIndentation', 'FormulaAudit/BottleDigestIndentation')
}
