...
pub fn ruby_components_redundancy_spec_l7_d1_cop(args ...ruby.Value) ruby.Value {
	return ruby.object_value('RuboCop::Cop::FormulaAudit::ComponentsRedundancy', 'FormulaAudit/ComponentsRedundancy')
}
