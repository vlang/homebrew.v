...
pub fn ruby_warnings_spec_l7_d1_restores(args ...ruby.Value) ruby.Value {
	base := homebrew.WarningFilter{}
	_ := homebrew.with_ignored_warnings(base, ['ignored warning'], fn (_ homebrew.WarningFilter) ![]string {
		return error('failure')
	}) or { [] }
	return ruby.bool_value(base.emit('ignored warning\n') == 'ignored warning\n')
}

// Ruby it `it "supports nested ignored warnings" do` at line 15.
pub fn ruby_warnings_spec_l15_d2_supports(args ...ruby.Value) ruby.Value {
	base := homebrew.WarningFilter{}
	...
	return ruby.bool_value(output.join('') == 'inner warning\nouter warning\n')
}
