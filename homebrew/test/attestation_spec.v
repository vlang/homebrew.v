...
pub fn ruby_attestation_spec_l7_d1_fake_gh(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.object_value('Pathname', attestation_spec_fake_gh)
}

// Ruby let `let(:fake_gh_creds) { "fake-gh-api-token" }` at line 8.
pub fn ruby_attestation_spec_l8_d2_fake_gh_creds(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.string_value(attestation_spec_creds)
}

// Ruby let `let(:fake_error_status) { instance_double(Process::Status, exitstatus: 1, termsig: nil) }` at line 9.
pub fn ruby_attestation_spec_l9_d3_fake_error_status(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_attestation_spec_l10_d4_fake_auth_status(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.structured_value('Process::Status', 'exit 4', {
		'exitstatus': '4'
		'termsig':    ''
	})
}
...
pub fn ruby_attestation_spec_l11_d5_cached_download(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.string_value(attestation_spec_cached_download)
}

// Ruby let `let(:fake_bottle_filename) do` at line 12.
pub fn ruby_attestation_spec_l12_d6_fake_bottle_filename(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.structured_value('Bottle::Filename', attestation_spec_filename, {
		'name':    'fakebottle'
		'version': '1.0'
	})
}
...
pub fn ruby_attestation_spec_l16_d7_fake_bottle_url(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.string_value(attestation_spec_url)
}

// Ruby let `let(:fake_bottle_tag) { instance_double(Utils::Bottles::Tag, to_sym: :faketag) }` at line 17.
pub fn ruby_attestation_spec_l17_d8_fake_bottle_tag(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.object_value('Utils::Bottles::Tag', 'faketag')
}

// Ruby let `let(:fake_all_bottle_tag) { instance_double(Utils::Bottles::Tag, to_sym: :all) }` at line 18.
pub fn ruby_attestation_spec_l18_d9_fake_all_bottle_tag(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.object_value('Utils::Bottles::Tag', 'all')
}

// Ruby let `let(:fake_bottle) do` at line 19.
pub fn ruby_attestation_spec_l19_d10_fake_bottle(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.attestation_bottle_value(attestation_spec_bottle(false))
}

// Ruby let `let(:fake_all_bottle) do` at line 23.
pub fn ruby_attestation_spec_l23_d11_fake_all_bottle(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_attestation_spec_l27_d12_fake_result_invalid_json(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_attestation_spec_l28_d13_fake_result_json_resp(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_attestation_spec_l37_d14_fake_result_json_resp_multi_subject(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_attestation_spec_l46_d15_fake_result_json_resp_backfill(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_attestation_spec_l58_d16_fake_result_json_resp_too_new(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_attestation_spec_l67_d17_fake_json_resp_wrong_sub(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_attestation_spec_l78_d18_calls(args ...brew_runtime.Value) brew_runtime.Value {
	...
	return brew_runtime.bool_value(path == attestation_spec_fake_gh && runtime.ensure_calls == 1)
}

// Ruby let `let(:gh) { Formula["gh"] }` at line 90.
pub fn ruby_attestation_spec_l90_d19_gh(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.structured_value('Formula', 'gh', {
		'full_name': 'gh'
	})
}

// Ruby let `let(:other) { Formula["other"] }` at line 91.
pub fn ruby_attestation_spec_l91_d20_other(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.structured_value('Formula', 'other', {
		'full_name': 'other'
	})
}

// Ruby it `it "moves `gh` formulae to the front of the list" do` at line 99.
pub fn ruby_attestation_spec_l99_d21_moves(args ...brew_runtime.Value) brew_runtime.Value {
	...
	return brew_runtime.bool_value(one == [gh] && two == [gh, other] && moved == [gh, other] && runtime.ensure_calls == 0)
}

// Ruby it `it "checks for the `gh` executable" do` at line 113.
pub fn ruby_attestation_spec_l113_d22_checks(args ...brew_runtime.Value) brew_runtime.Value {
	mut runtime := homebrew.AttestationRuntime{}
	result := homebrew.attestation_sort_formulae_for_install([], mut runtime, homebrew.attestation_injected_collaborators()) or {
		return brew_runtime.bool_value(false)
	}
	return brew_runtime.bool_value(result.len == 0 && runtime.ensure_calls == 1)
}

// Ruby it `it "checks for the `gh` executable" do` at line 120.
pub fn ruby_attestation_spec_l120_d23_checks(args ...brew_runtime.Value) brew_runtime.Value {
	other := homebrew.AttestationFormula{ full_name: 'other' }
	mut runtime := homebrew.AttestationRuntime{}
	result := homebrew.attestation_sort_formulae_for_install([other], mut runtime, homebrew.attestation_injected_collaborators()) or {
		return brew_runtime.bool_value(false)
	}
	return brew_runtime.bool_value(result == [other] && runtime.ensure_calls == 1)
}

// Ruby it `it "raises without any gh credentials" do` at line 133.
pub fn ruby_attestation_spec_l133_d24_raises(args ...brew_runtime.Value) brew_runtime.Value {
	...
	if _ := homebrew.check_bottle_attestation(mut runtime, attestation_spec_bottle(false), homebrew.attestation_homebrew_core_repo, none, none, '', homebrew.attestation_injected_collaborators()) {
		...
		return brew_runtime.bool_value(err.msg() == 'GhAuthNeeded: missing credentials' && runtime.commands.len == 0)
	}
}

// Ruby it `it "raises when gh subprocess fails" do` at line 143.
pub fn ruby_attestation_spec_l143_d25_raises(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.bool_value(attestation_spec_check_error(attestation_spec_failure(1, ''), 'InvalidAttestationError:'))
}

// Ruby it `it "raises auth error when gh subprocess fails with auth exit code" do` at line 160.
pub fn ruby_attestation_spec_l160_d26_raises(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.bool_value(attestation_spec_check_error(attestation_spec_failure(4, ''), 'GhAuthInvalid: invalid credentials'))
}

// Ruby it `it "raises when gh returns invalid JSON" do` at line 177.
pub fn ruby_attestation_spec_l177_d27_raises(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.bool_value(attestation_spec_check_error(attestation_spec_success('"invalid JSON'), 'InvalidAttestationError: attestation verification returned malformed JSON'))
}

// Ruby it `it "raises when gh returns other subjects" do` at line 194.
pub fn ruby_attestation_spec_l194_d28_raises(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.bool_value(attestation_spec_check_error(attestation_spec_wrong_subject_result(), 'InvalidAttestationError: no attestation matches subject: ${attestation_spec_filename}'))
}

// Ruby it `it "checks subject prefix when the bottle is an :all bottle" do` at line 211.
pub fn ruby_attestation_spec_l211_d29_checks(args ...brew_runtime.Value) brew_runtime.Value {
	...
	return brew_runtime.bool_value(record.subjects == [attestation_spec_filename] && attestation_spec_command_is_core(runtime.commands[0]))
}

// Ruby it `it "calls gh with args for homebrew-core" do` at line 235.
pub fn ruby_attestation_spec_l235_d30_calls(args ...brew_runtime.Value) brew_runtime.Value {
	mut runtime := attestation_spec_runtime([attestation_spec_normal_result()])
	...
	return brew_runtime.bool_value(record.subjects == [attestation_spec_filename] && runtime.commands.len == 1 && attestation_spec_command_is_core(runtime.commands[0]))
}

// Ruby it `it "calls gh with args for homebrew-core and handles a multi-subject attestation" do` at line 246.
pub fn ruby_attestation_spec_l246_d31_calls(args ...brew_runtime.Value) brew_runtime.Value {
	mut runtime := attestation_spec_runtime([attestation_spec_multi_result()])
	record := homebrew.check_core_bottle_attestation(mut runtime, attestation_spec_bottle(false), attestation_spec_creds, true, homebrew.attestation_injected_collaborators()) or {
		return brew_runtime.bool_value(false)
	}
	return brew_runtime.bool_value(record.subjects == ['nonsense', attestation_spec_filename] && runtime.commands.len == 1 && attestation_spec_command_is_core(runtime.commands[0]))
}

// Ruby it `it "calls gh with args for backfill when homebrew-core attestation is missing" do` at line 257.
pub fn ruby_attestation_spec_l257_d32_calls(args ...brew_runtime.Value) brew_runtime.Value {
	mut runtime := attestation_spec_runtime([
	...
	return brew_runtime.bool_value(record.subjects == [
		attestation_spec_backfill_subject(),
...
pub fn ruby_attestation_spec_l276_d33_raises(args ...brew_runtime.Value) brew_runtime.Value {
	...
	if _ := homebrew.check_core_bottle_attestation(mut runtime, attestation_spec_bottle(false), attestation_spec_creds, true, homebrew.attestation_injected_collaborators()) {
		...
		return brew_runtime.bool_value(err.msg().starts_with('InvalidAttestationError:') && core_count == homebrew.attestation_max_retries + 1 && backfill_count == homebrew.attestation_max_retries + 1 && runtime.sleeps.len == 0)
	}
}
