...
fn exception_spec_formula(name string) brew_runtime.Value {
...
fn exception_spec_tap(installed bool) brew_runtime.Value {
	return brew_runtime.structured_value('Tap', 'u/r', {
		'user':       'u'
		'repository': 'r'
...
fn exception_spec_resource() brew_runtime.Value {
	return brew_runtime.object_value('Resource', '<resource foo>')
}

fn exception_spec_class(name string, derived bool) brew_runtime.Value {
	return brew_runtime.structured_value('Class', name, {
		'name':            name
		'derived_formula': derived.str()
	})
}

fn exception_spec_message(value brew_runtime.Value) string {
	return homebrew.brew_exception_from_value(value).message
}

fn exception_spec_result(ok bool) brew_runtime.Value {
	return brew_runtime.bool_value(ok)
}

fn exception_spec_formula_class(list []brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l255_d37_initialize(brew_runtime.string_value('foo'), brew_runtime.string_value('foo.rb'), brew_runtime.string_value('Foo'), brew_runtime.array_value(list))
}

fn exception_spec_formula_unavailable(dependent string) brew_runtime.Value {
	return homebrew.brew_exception_value(homebrew.new_brew_exception('FormulaUnavailableError', 'No available formula with the name "foo"${homebrew.formula_dependent_suffix('foo', dependent)}.', {
		...
		'dependent': if dependent.len > 0 {
			brew_runtime.string_value(dependent)
		} else {
...
pub fn ruby_exceptions_spec_l40_d8_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l91_d12_initialize(brew_runtime.string_value('foo'), brew_runtime.string_value('sha257'), brew_runtime.string_value('magic'))
}
...
pub fn ruby_exceptions_spec_l48_d10_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l161_d22_initialize(exception_spec_tap(false), brew_runtime.string_value('foo'))
}
...
pub fn ruby_exceptions_spec_l92_d19_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l306_d45_initialize(exception_spec_tap(false), brew_runtime.string_value('foo'))
}
...
pub fn ruby_exceptions_spec_l102_d22_error(args ...brew_runtime.Value) brew_runtime.Value {
	list := if args.len > 0 { args[0].array_data } else { []brew_runtime.Value{} }
...
pub fn ruby_exceptions_spec_l104_d23_mod(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.array_value([exception_spec_class('Bar', false),
...
pub fn ruby_exceptions_spec_l114_d25_to_s(args ...brew_runtime.Value) brew_runtime.Value {
	value := if args.len > 0 {
		...
		exception_spec_formula_class([]brew_runtime.Value{})
	}
...
pub fn ruby_exceptions_spec_l133_d28_list(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.array_value([exception_spec_class('Baz', true)])
}
...
pub fn ruby_exceptions_spec_l141_d30_error(args ...brew_runtime.Value) brew_runtime.Value {
	...
	return homebrew.ruby_exceptions_l287_d41_initialize(brew_runtime.string_value('foo'), error_value)
}
...
pub fn ruby_exceptions_spec_l143_d31_formula_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.brew_exception_value(homebrew.new_brew_exception('LoadError', 'bar', map[string]brew_runtime.Value{}))
}
...
pub fn ruby_exceptions_spec_l149_d33_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l398_d58_initialize(brew_runtime.string_value('foo'), brew_runtime.string_array_value([]string{}))
}
...
pub fn ruby_exceptions_spec_l155_d35_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l464_d66_initialize(brew_runtime.string_value('foo'))
}
...
pub fn ruby_exceptions_spec_l161_d37_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l631_d86_initialize(exception_spec_formula('foo'), brew_runtime.string_value('badprg'), brew_runtime.array_value([
		brew_runtime.string_value('arg1'),
		brew_runtime.int_value(2),
		brew_runtime.object_value('Pathname', 'arg3'),
		brew_runtime.object_value('Symbol', 'arg4'),
...
pub fn ruby_exceptions_spec_l169_d40_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l494_d69_initialize(brew_runtime.object_value('Pathname', 'foo'))
}
...
pub fn ruby_exceptions_spec_l183_d45_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l544_d74_initialize(exception_spec_formula('foo/qux'), brew_runtime.array_value([
...
pub fn ruby_exceptions_spec_l186_d47_conflict(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.structured_value('Formula::FormulaConflict', 'bar', {
		'name':   'bar'
		'reason': 'I decided to'
	})
}
...
pub fn ruby_exceptions_spec_l192_d49_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l786_d92_initialize(exception_spec_formula('foo'), brew_runtime.string_value('Install a supported compiler.'))
}
...
pub fn ruby_exceptions_spec_l201_d52_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l813_d95_initialize(brew_runtime.string_value('file:///tmp/foo'))
}
...
pub fn ruby_exceptions_spec_l207_d54_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l813_d95_initialize(brew_runtime.string_value('https://brew.sh'))
}
...
pub fn ruby_exceptions_spec_l214_d56_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l857_d102_initialize(brew_runtime.string_array_value([
		'badprg',
		'arg1',
		'arg2',
...
pub fn ruby_exceptions_spec_l216_d57_status(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.structured_value('Process::Status', 'exit 17', {
		'exitstatus': '17'
		'termsig':    ''
	})
}
...
pub fn ruby_exceptions_spec_l222_d59_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l931_d105_initialize(brew_runtime.string_value('/file.tar.gz'), ruby_exceptions_spec_l224_d60_expected_checksum(), ruby_exceptions_spec_l225_d61_actual_checksum())
}
...
pub fn ruby_exceptions_spec_l224_d60_expected_checksum(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.object_value('Checksum', 'deadbeef')
}
...
pub fn ruby_exceptions_spec_l225_d61_actual_checksum(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.object_value('Checksum', 'deadcafe')
}
...
pub fn ruby_exceptions_spec_l268_d72_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l995_d109_initialize(brew_runtime.string_value('/foo.bottle.tar.gz'), brew_runtime.string_value('foo/1.0/.brew/foo.rb'))
}
...
pub fn ruby_exceptions_spec_l276_d75_error(args ...brew_runtime.Value) brew_runtime.Value {
	return homebrew.ruby_exceptions_l756_d91_initialize(brew_runtime.string_array_value([
		'-s',
	]), brew_runtime.bool_value(true), brew_runtime.string_value('Install the Command Line Tools for Xcode.'))
}
