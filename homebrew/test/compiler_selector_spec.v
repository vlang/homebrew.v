...
fn compiler_selector_spec_versions_value() ruby.Value {
	return ruby.map_value({
		'gcc-12':              ruby.object_value('Version', '12.1')
		'gcc-11':              ruby.object_value('Version', '11.1')
		'gcc-10':              ruby.object_value('Version', '10.1')
		'gcc-9':               ruby.object_value('Version', '9.1')
		'clang_build_version': ruby.object_value('Version', '600')
	})
}

fn compiler_selector_spec_formula() ruby.Value {
	return ruby.Value{
		type_name: 'SoftwareSpec'
		repr: '#<SoftwareSpec>'
		map_data: {
			'compiler_failures': ruby.array_value([])
		}
	}
}
...
fn compiler_selector_spec_result(value bool) ruby.Value {
	return ruby.bool_value(value)
}

// Ruby subject `subject(:selector) { described_class.new(software_spec, versions, compilers) }` at line 8.
pub fn ruby_compiler_selector_spec_l8_d1_selector(args ...ruby.Value) ruby.Value {
	return compiler_model.ruby_compiler_selector_l57_initialize(compiler_selector_spec_formula(), compiler_selector_spec_versions_value(), ruby.string_array_value([
		'clang',
		'gnu',
	]))
}
...
pub fn ruby_compiler_selector_spec_l10_d2_compilers(args ...ruby.Value) ruby.Value {
	return ruby.string_array_value(['clang', 'gnu'])
}

// Ruby let `let(:software_spec) { SoftwareSpec.new }` at line 11.
pub fn ruby_compiler_selector_spec_l11_d3_software_spec(args ...ruby.Value) ruby.Value {
	return compiler_selector_spec_formula()
}

// Ruby let `let(:cc) { :clang }` at line 12.
pub fn ruby_compiler_selector_spec_l12_d4_cc(args ...ruby.Value) ruby.Value {
...
pub fn ruby_compiler_selector_spec_l13_d5_versions(args ...ruby.Value) ruby.Value {
	return compiler_selector_spec_versions_value()
}

// Ruby it `it "defaults to cc" do` at line 28.
pub fn ruby_compiler_selector_spec_l28_d6_defaults(args ...ruby.Value) ruby.Value {
...
pub fn ruby_compiler_selector_spec_l32_d7_returns(args ...ruby.Value) ruby.Value {
...
pub fn ruby_compiler_selector_spec_l37_d8_still(args ...ruby.Value) ruby.Value {
	selected := compiler_selector_spec_select([
...
pub fn ruby_compiler_selector_spec_l42_d9_returns(args ...ruby.Value) ruby.Value {
	selected := compiler_selector_spec_select([
		compiler_selector_spec_symbol_failure('clang'),
...
pub fn ruby_compiler_selector_spec_l50_d10_returns(args ...ruby.Value) ruby.Value {
	selected := compiler_selector_spec_select([
		compiler_selector_spec_symbol_failure('clang'),
...
pub fn ruby_compiler_selector_spec_l58_d11_returns(args ...ruby.Value) ruby.Value {
	selected := compiler_selector_spec_select([
		compiler_selector_spec_symbol_failure('clang'),
...
pub fn ruby_compiler_selector_spec_l68_d12_returns(args ...ruby.Value) ruby.Value {
...
pub fn ruby_compiler_selector_spec_l77_d13_returns(args ...ruby.Value) ruby.Value {
	selected := compiler_selector_spec_select([
		compiler_selector_spec_symbol_failure('clang'),
...
pub fn ruby_compiler_selector_spec_l83_d14_returns(args ...ruby.Value) ruby.Value {
	selected := compiler_selector_spec_select([
		compiler_selector_spec_symbol_failure('clang'),
...
pub fn ruby_compiler_selector_spec_l89_d15_raises(args ...ruby.Value) ruby.Value {
...
pub fn ruby_compiler_selector_spec_l99_d16_raises(args ...ruby.Value) ruby.Value {
	selector := compiler_selector_spec_selector([
		compiler_selector_spec_symbol_failure('clang'),
