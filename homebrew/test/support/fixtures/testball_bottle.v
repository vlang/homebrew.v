...
pub fn ruby_testball_bottle_l7_d1_initialize(args ...ruby.Value) ruby.Value {
...
pub fn ruby_testball_bottle_l25_d2_self_inherited(args ...ruby.Value) ruby.Value {
	other := if args.len > 0 {
		args[0]
	} else {
		ruby.object_value('Class', 'TestballBottleSubclass')
	}
...
pub fn ruby_testball_bottle_l30_d3_install(args ...ruby.Value) ruby.Value {
