...
pub fn ruby_quiet_progress_formatter_l9_d1_dump_summary(args ...ruby.Value) ruby.Value {
	return quiet_progress_formatter_noop(args)
}

// Ruby method `seed(notification); end` at line 10.
pub fn ruby_quiet_progress_formatter_l10_d2_seed(args ...ruby.Value) ruby.Value {
	return quiet_progress_formatter_noop(args)
}

// Ruby method `close(notification); end` at line 11.
pub fn ruby_quiet_progress_formatter_l11_d3_close(args ...ruby.Value) ruby.Value {
	return quiet_progress_formatter_noop(args)
}

pub fn quiet_progress_formatter_noop(_notification []ruby.Value) ruby.Value {
