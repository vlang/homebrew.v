...
fn info_spec_bool(value bool) ruby.Value {
	return ruby.bool_value(value)
}

fn info_spec_tap(name string) ruby.Value {
...
fn info_spec_dependency(name string, kind string, installed bool, outdated bool,
	any_installed bool) ruby.Value {
	return ruby.structured_value('Dependency', name, {
		'name':                  name
		'kind':                  kind
...
fn info_spec_requirement(display string, kind string, satisfied bool,
	other_os bool) ruby.Value {
	return ruby.structured_value(if other_os { 'LinuxRequirement' } else { 'Requirement' }, display, {
		'display':   display
		'kind':      kind
...
fn info_spec_conflict(name string, resolved string) ruby.Value {
	return ruby.structured_value('FormulaConflict', name, {
		'name':               name
		'resolved_full_name': resolved
	})
}

fn info_spec_installed_formula() ruby.Value {
	...
	return info_spec_formula('testball', {
		...
		'installed_kegs': ruby.array_value([keg])
		'tab':            tab
	})
}

fn info_spec_installed_cask() ruby.Value {
...
fn info_spec_formula_with_resolution(qualified bool) ruby.Value {
	...
	installed := info_spec_formula('testball', {
		...
		'installed_kegs': base.map_data['installed_kegs'] or { ruby.array_value([]) }
	})
...
fn info_spec_json_valid(value ruby.Value) bool {
	json2.decode[json2.Any](value.as_string()) or { return false }
	return true
}

fn info_spec_json_array_length(value ruby.Value, key string) ?int {
...
fn info_spec_dependency_output(formula_installed bool, dependency ruby.Value,
	runtime []string, installed_runtime []string) string {
	mut fields := {
		'dependencies': ruby.array_value([dependency])
	}
	if formula_installed {
		tab := info_spec_tab(false, 'homebrew/core', runtime, false)
		fields['installed_kegs'] = ruby.array_value([
...
fn info_spec_with_related(base ruby.Value, related []ruby.Value) ruby.Value {
	mut fields := base.map_data.clone()
	fields['related'] = ruby.array_value(related)
	return ruby.Value{
...
pub fn ruby_info_spec_l21_d1_installed_info_formula(args ...ruby.Value) ruby.Value {
	return info_spec_installed_formula()
}

// Ruby method `installed_info_cask` at line 31.
pub fn ruby_info_spec_l31_d2_installed_info_cask(args ...ruby.Value) ruby.Value {
	return info_spec_installed_cask()
}

// Ruby it `it "prints as json with the --json=v1 flag" do` at line 44.
pub fn ruby_info_spec_l44_d3_prints(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'description': 'Some test'
	}, {})
	result := info_cmd.ruby_info_l729_d29_print_json(ruby.map_value({
		'named_formulae': ruby.array_value([formula])
	}), ruby.string_value('v1'), ruby.bool_value(false))
...
pub fn ruby_info_spec_l58_d4_prints(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {}, {})
	result := info_cmd.ruby_info_l729_d29_print_json(ruby.map_value({
		'named_formulae': ruby.array_value([formula])
	}), ruby.string_value('v2'), ruby.bool_value(false))
...
pub fn ruby_info_spec_l67_d5_does(args ...ruby.Value) ruby.Value {
	formula := info_spec_installed_formula()
	result_with_data := info_cmd.ruby_info_l729_d29_print_json(ruby.Value{
		...
		map_data: {
			'installed_formulae': ruby.array_value([formula])
			'installed_casks':    ruby.array_value([
...
pub fn ruby_info_spec_l86_d6_does(args ...ruby.Value) ruby.Value {
	result := info_cmd.ruby_info_l729_d29_print_json(ruby.Value{
		type_name: 'InfoContext'
		attributes: {
			'formula_only': 'true'
		}
		map_data: {
			'all_formulae': ruby.array_value([info_spec_installed_formula()])
			'all_casks':    ruby.array_value([info_spec_installed_cask()])
		}
	}, ruby.string_value('v2'), ruby.bool_value(true))
...
pub fn ruby_info_spec_l106_d7_prints(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l129_d8_prints(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l152_d9_omits(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l180_d10_omits(args ...ruby.Value) ruby.Value {
	tab := info_spec_tab(none, 'homebrew/core', [], false)
	return info_spec_bool(info_cmd.ruby_info_l192_d6_self_installation_summary(ruby.string_value('0.1'), tab).as_string() == 'Installed: 0.1')
}

// Ruby it `it "marks installed formulae in interactive inventory output" do` at line 211.
pub fn ruby_info_spec_l211_d11_marks(args ...ruby.Value) ruby.Value {
	installed := info_spec_installed_formula()
	mut attributes := installed.attributes.clone()
	attributes['tty'] = 'true'
	output := info_cmd.ruby_info_l404_d19_info_formula_summary(ruby.Value{
		...installed
		attributes: attributes
	}).as_string()
...
pub fn ruby_info_spec_l230_d12_prints(args ...ruby.Value) ruby.Value {
	...
	result := info_cmd.ruby_info_l93_d1_run(ruby.Value{
		type_name: 'InfoContext'
		attributes: {
			'installed': 'true'
			'verbose':   'true'
		...
		map_data: {
			'installed_packages': ruby.array_value([formula, cask])
		}
	})
...
pub fn ruby_info_spec_l245_d13_prints(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'description': 'Some test'
	}, {})
...
pub fn ruby_info_spec_l264_d14_uses(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'description': 'Some test'
	}, {})
	result := info_cmd.ruby_info_l318_d15_print_info(ruby.Value{
		type_name: 'InfoContext'
		attributes: {
			'quiet': 'true'
		}
		map_data: {
			'objects': ruby.array_value([formula])
		}
...
pub fn ruby_info_spec_l278_d15_prints(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'description':    'Some test'
...
pub fn ruby_info_spec_l300_d16_shows(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {}, {
		'conflicts': ruby.array_value([
...
pub fn ruby_info_spec_l316_d17_omits(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {}, {
		'conflicts': ruby.array_value([
...
pub fn ruby_info_spec_l330_d18_marks(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'deprecated': 'true'
		'tty':        'true'
	}, {})
...
pub fn ruby_info_spec_l348_d19_marks(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'disabled': 'true'
		'tty':      'true'
	}, {})
...
pub fn ruby_info_spec_l366_d20_shows(args ...ruby.Value) ruby.Value {
	...
	result := info_cmd.ruby_info_l318_d15_print_info(ruby.Value{
		...
		map_data: {
			'objects': ruby.array_value([formula, formula])
		}
	})
...
pub fn ruby_info_spec_l388_d21_reports(args ...ruby.Value) ruby.Value {
	error_value := ruby.object_value('FormulaOrCaskUnavailableError', 'No available formula or cask with the name "nonexistent-formula"')
	result := info_cmd.ruby_info_l318_d15_print_info(ruby.map_value({
		'objects': ruby.array_value([error_value])
	}))
	stderr := result.map_data['stderr'] or { ruby.string_value('') }
...
pub fn ruby_info_spec_l400_d22_qualifies(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula_with_resolution(false)
	output := info_cmd.ruby_info_l426_d20_info_formula(formula).as_string()
...
pub fn ruby_info_spec_l418_d23_reloads(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula_with_resolution(false)
...
pub fn ruby_info_spec_l439_d24_resolves(args ...ruby.Value) ruby.Value {
	...
	formula := info_spec_formula('testball', {
		...
		'installed_kegs':     ruby.array_value([
...
pub fn ruby_info_spec_l451_d25_returns(args ...ruby.Value) ruby.Value {
	formula := info_spec_installed_formula()
	resolution := info_cmd.ruby_info_l358_d17_installed_resolution(formula).as_array() or { [] }
...
pub fn ruby_info_spec_l463_d26_returns(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l477_d27_warns(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {}, {})
...
pub fn ruby_info_spec_l491_d28_treats(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {}, {})
	return info_cmd.ruby_info_l347_d16_formula_qualified_by_user(formula, ruby.string_array_value([
		'homebrew/core/testball',
	]))
}

// Ruby it `it "treats a bare unqualified input as not user-qualified" do` at line 503.
pub fn ruby_info_spec_l503_d29_treats(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {}, {})
	return info_spec_bool(!info_cmd.ruby_info_l347_d16_formula_qualified_by_user(formula, ruby.string_array_value([])).bool_data)
}

// Ruby it `it "--json swaps an unqualified-input formula to its installed tap" do` at line 513.
pub fn ruby_info_spec_l513_d30_json(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula_with_resolution(false)
	output := info_cmd.ruby_info_l729_d29_print_json(ruby.Value{
		type_name: 'InfoContext'
		map_data: {
			'named_formulae': ruby.array_value([formula])
		}
	}, ruby.bool_value(true), ruby.bool_value(false)).as_string()
...
pub fn ruby_info_spec_l540_d31_json(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula_with_resolution(false)
	output := info_cmd.ruby_info_l729_d29_print_json(ruby.Value{
		type_name: 'InfoContext'
		attributes: {
...
pub fn ruby_info_spec_l561_d32_prints(args ...ruby.Value) ruby.Value {
	...
	formula := info_spec_formula('testball', {
		...
		'dependencies':   ruby.array_value([dep])
		'installed_kegs': ruby.array_value([
			info_spec_keg('testball', '0.1', 1, false, [], tab),
		])
	})
...
pub fn ruby_info_spec_l617_d33_lists(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
	...
	output := info_cmd.ruby_info_l426_d20_info_formula(formula, ruby.object_value('NilClass', 'nil'), ruby.bool_value(true)).as_string()
...
pub fn ruby_info_spec_l654_d34_summarises(args ...ruby.Value) ruby.Value {
	dep := info_spec_dependency('bar', 'required', true, false, false)
...
pub fn ruby_info_spec_l691_d35_marks(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l718_d36_marks(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l755_d37_marks(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l792_d38_marks(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l822_d39_marks(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l852_d40_marks(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l882_d41_does(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l992_d45_shows(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'outdated':       'true'
		'version':        '0.1'
		'stable_version': '0.1'
...
pub fn ruby_info_spec_l1014_d46_prints(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'tty': 'true'
	}, {
		'requirements': ruby.array_value([
...
pub fn ruby_info_spec_l1036_d47_hides(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'tty': 'true'
	}, {
		'requirements': ruby.array_value([
...
pub fn ruby_info_spec_l1058_d48_prints(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {}, {
		'installed_kegs': ruby.array_value([info_spec_keg('testball', '0.1', 1, false, [
			'testball',
			'another',
			'daemon',
...
pub fn ruby_info_spec_l1087_d49_prints(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
...
pub fn ruby_info_spec_l1111_d50_omits(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {}, {
		'installed_kegs': ruby.array_value([info_spec_keg('testball', '0.1', 1, false, [
			'testball',
		], info_spec_tab(false, 'homebrew/core', [], false))])
...
pub fn ruby_info_spec_l1137_d51_omits(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {}, {
		'installed_kegs': ruby.array_value([
			info_spec_keg('testball', '0.1', 1, false, [], info_spec_tab(false, 'homebrew/core', [], false)),
		])
	})
	return info_spec_bool(!info_cmd.ruby_info_l426_d20_info_formula(formula, ruby.object_value('NilClass', 'nil'), ruby.bool_value(true)).as_string().contains('==> Binaries'))
}

// Ruby it `it "prints on-request installs explicitly" do` at line 1161.
pub fn ruby_info_spec_l1161_d52_prints(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l1166_d53_treats(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l1175_d54_returns(args ...ruby.Value) ruby.Value {
	...
	lines := info_cmd.ruby_info_l156_d3_self_metadata_lines(formula, ruby.bool_value(true)).as_string_array() or { [] }
	expected_time := info_cmd.ruby_info_l257_d11_self_formatted_time(ruby.int_value(stamp)).as_string()
	return info_spec_bool(lines == ['Pinned: 1.0 on ${expected_time}'])
}

// Ruby it `it "returns summary lines for pinned casks" do` at line 1195.
pub fn ruby_info_spec_l1195_d55_returns(args ...ruby.Value) ruby.Value {
	stamp := i64(1_720_189_900)
	...
	lines := info_cmd.ruby_info_l156_d3_self_metadata_lines(cask, ruby.bool_value(true)).as_string_array() or { [] }
	expected_time := info_cmd.ruby_info_l257_d11_self_formatted_time(ruby.int_value(stamp)).as_string()
	return info_spec_bool(lines == ['Pinned: 1.0 on ${expected_time}'])
}

// Ruby let `let(:remote) { "https://github.com/Homebrew/homebrew-core" }` at line 1217.
pub fn ruby_info_spec_l1217_d56_remote(args ...ruby.Value) ruby.Value {
	return ruby.string_value('https://github.com/Homebrew/homebrew-core')
}

// Ruby specify `specify "returns correct URLs" do` at line 1219.
pub fn ruby_info_spec_l1219_d57_returns(args ...ruby.Value) ruby.Value {
	remote := ruby_info_spec_l1217_d56_remote()
	path := ruby.string_value('Formula/git.rb')
	return info_spec_bool(info_cmd.ruby_info_l147_d2_github_remote_path(remote, path).as_string() == 'https://github.com/Homebrew/homebrew-core/blob/HEAD/Formula/git.rb' && info_cmd.ruby_info_l147_d2_github_remote_path(ruby.string_value('${remote.repr}.git'), path).as_string() == 'https://github.com/Homebrew/homebrew-core/blob/HEAD/Formula/git.rb' && info_cmd.ruby_info_l147_d2_github_remote_path(ruby.string_value('git@github.com:user/repo'), ruby.string_value('foo.rb')).as_string() == 'https://github.com/user/repo/blob/HEAD/foo.rb' && info_cmd.ruby_info_l147_d2_github_remote_path(ruby.string_value('https://mywebsite.com'), ruby.string_value('foo/bar.rb')).as_string() == 'https://mywebsite.com/foo/bar.rb')
}

// Ruby it `it "lists aliases on their own row when the formula has any" do` at line 1235.
pub fn ruby_info_spec_l1235_d58_lists(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
...
pub fn ruby_info_spec_l1250_d59_renders(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
...
pub fn ruby_info_spec_l1264_d60_renders(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'old_names': 'foo'
	}, {})
	output := info_cmd.ruby_info_l426_d20_info_formula(formula).as_string()
...
pub fn ruby_info_spec_l1279_d61_omits(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l1296_d62_lists(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l1332_d63_shows(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'version':  '2.0'
		'outdated': 'true'
	}, {
...
pub fn ruby_info_spec_l1357_d64_hides(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'version': '1.0'
	}, {
		'installed_kegs': ruby.array_value([
...
pub fn ruby_info_spec_l1381_d65_marks(args ...ruby.Value) ruby.Value {
	main := info_spec_formula('testball', {
		'version': '1.0'
	}, {
		'installed_kegs': ruby.array_value([
...
pub fn ruby_info_spec_l1416_d66_includes(args ...ruby.Value) ruby.Value {
	versioned := info_spec_formula('testball@0.9', {
		'version': '0.9'
	}, {
		'installed_kegs': ruby.array_value([
...
pub fn ruby_info_spec_l1453_d67_renders(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'version': '1.0'
	}, {
		'installed_kegs': ruby.array_value([
...
pub fn ruby_info_spec_l1474_d68_renders(args ...ruby.Value) ruby.Value {
	versioned := info_spec_formula('testball@0.9', {
		'version': '0.9'
	}, {})
	parent := info_spec_formula('testball', {
...
pub fn ruby_info_spec_l1502_d69_lists(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'version': '1.0'
	}, {
		'installed_kegs': ruby.array_value([
	...
	lines := info_cmd.ruby_info_l799_d31_installed_section_lines(formula, ruby.bool_value(true)).as_string_array() or { [] }
...
pub fn ruby_info_spec_l1532_d70_omits(args ...ruby.Value) ruby.Value {
	formula := info_spec_formula('testball', {
		'version': '1.0'
	}, {})
	return info_spec_bool((info_cmd.ruby_info_l799_d31_installed_section_lines(formula).as_string_array() or {
...
pub fn ruby_info_spec_l1548_d71_tap(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l1550_d72_returns(args ...ruby.Value) ruby.Value {
...
pub fn ruby_info_spec_l1563_d73_returns(args ...ruby.Value) ruby.Value {
	tap := ruby_info_spec_l1548_d71_tap()
