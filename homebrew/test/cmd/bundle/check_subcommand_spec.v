...
fn check_spec_bool(value bool) ruby.Value {
...
pub fn ruby_check_subcommand_spec_l10_d1_do_check(args ...ruby.Value) ruby.Value {
	_ = args
	return subcommand.ruby_check_l30_d1_run(brew_bundle.checker_state_value(check_spec_state({}, [], [])), ruby.bool_value(false), ruby.bool_value(false), ruby.bool_value(false), ruby.string_array_value([]))
}

// Ruby let `let(:context) { bundle_subcommand_context(:check, no_upgrade:, verbose:) }` at line 13.
pub fn ruby_check_subcommand_spec_l13_d2_context(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.map_value({
		'command':    ruby.object_value('Symbol', 'check')
		'no_upgrade': ruby.bool_value(false)
		'verbose':    ruby.bool_value(false)
	})
}

// Ruby let `let(:no_upgrade) { false }` at line 14.
pub fn ruby_check_subcommand_spec_l14_d3_no_upgrade(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.bool_value(false)
}

// Ruby let `let(:verbose) { false }` at line 15.
pub fn ruby_check_subcommand_spec_l15_d4_verbose(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.bool_value(false)
}

// Ruby it `it "does not raise an error" do` at line 27.
pub fn ruby_check_subcommand_spec_l27_d5_does(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l39_d6_does(args ...ruby.Value) ruby.Value {
	_ = args
	result := check_spec_run(check_spec_state({}, [], []), false, false, [])
...
pub fn ruby_check_subcommand_spec_l47_d7_raises(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l57_d8_verbose(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.bool_value(true)
}

// Ruby it `it "raises an error and outputs to stderr" do` at line 59.
pub fn ruby_check_subcommand_spec_l59_d9_raises(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l68_d10_partially(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l77_d11_does(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l96_d12_raises(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l104_d13_raises(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l113_d14_does(args ...ruby.Value) ruby.Value {
	_ = args
	return check_spec_bool(check_spec_run(check_spec_state({}, [], []), false, false, []).exit_code == 0)
}

// Ruby let `let(:verbose) { true }` at line 122.
pub fn ruby_check_subcommand_spec_l122_d15_verbose(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.bool_value(true)
}

// Ruby it `it "outputs the link status error" do` at line 124.
pub fn ruby_check_subcommand_spec_l124_d16_outputs(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l132_d17_outputs(args ...ruby.Value) ruby.Value {
	_ = args
	result := check_spec_package_error('brew', 'Formula abc needs to be unlinked.', true, false)
...
pub fn ruby_check_subcommand_spec_l143_d18_raises(args ...ruby.Value) ruby.Value {
	_ = args
	return check_spec_bool(check_spec_package_error('brew', 'Formula abc needs to be linked.', false, false).exit_code == 1)
}

// Ruby it `it "raises an error" do` at line 159.
pub fn ruby_check_subcommand_spec_l159_d19_raises(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l168_d20_raises(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l177_d21_verbose(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.bool_value(true)
}

// Ruby let `let(:expected_output) do` at line 178.
pub fn ruby_check_subcommand_spec_l178_d22_expected_output(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.string_value(check_spec_expected_service_output())
}

// Ruby it `it "does not raise error when no service needs to be started" do` at line 197.
pub fn ruby_check_subcommand_spec_l197_d23_does(args ...ruby.Value) ruby.Value {
	_ = args
	return check_spec_bool(check_spec_run(check_spec_state({}, [], []), true, false, []).exit_code == 0)
}

// Ruby it `it "raises an error" do` at line 209.
pub fn ruby_check_subcommand_spec_l209_d24_raises(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l219_d25_raises(args ...ruby.Value) ruby.Value {
	_ = args
	state := check_spec_state({}, [brew_bundle.CheckerExtension{
		legacy_check_step: 'apps_to_install'
		errors: ['App foo needs to be installed or updated.']
...
pub fn ruby_check_subcommand_spec_l230_d26_expected_output(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.string_value(check_spec_expected_no_upgrade_output())
}

// Ruby let `let(:no_upgrade) { true }` at line 237.
pub fn ruby_check_subcommand_spec_l237_d27_no_upgrade(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.bool_value(true)
}

// Ruby let `let(:verbose) { true }` at line 238.
pub fn ruby_check_subcommand_spec_l238_d28_verbose(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.bool_value(true)
}

// Ruby it `it "raises an error that doesn't mention upgrade" do` at line 247.
pub fn ruby_check_subcommand_spec_l247_d29_raises(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l256_d30_expected_output(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.string_value(check_spec_expected_extension_output())
}

// Ruby let `let(:verbose) { true }` at line 263.
pub fn ruby_check_subcommand_spec_l263_d31_verbose(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.bool_value(true)
}

// Ruby it `it "raises an error that doesn't mention upgrade" do` at line 271.
pub fn ruby_check_subcommand_spec_l271_d32_raises(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l283_d33_does(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l288_d34_does(args ...ruby.Value) ruby.Value {
	_ = args
	state := check_spec_state({
		'tap':  ['Tap asdf needs to be installed or updated.']
		'brew': ['Formula ignored needs to be installed or updated.']
...
pub fn ruby_check_subcommand_spec_l293_d35_does(args ...ruby.Value) ruby.Value {
	_ = args
	state := check_spec_state({
		'tap': ['Tap asdf needs to be installed or updated.']
	}, [brew_bundle.CheckerExtension{
...
pub fn ruby_check_subcommand_spec_l305_d36_does(args ...ruby.Value) ruby.Value {
	_ = args
	state := check_spec_state({
		'brew': ['Formula ignored needs to be installed or updated.']
	}, [brew_bundle.CheckerExtension{
...
pub fn ruby_check_subcommand_spec_l310_d37_does(args ...ruby.Value) ruby.Value {
	_ = args
	state := check_spec_state({}, [brew_bundle.CheckerExtension{
		legacy_check_step: 'registered_extensions_to_install'
		errors: ['VSCode Extension asdf needs to be installed.']
...
pub fn ruby_check_subcommand_spec_l326_d38_does(args ...ruby.Value) ruby.Value {
	_ = args
	state := check_spec_state({
...
pub fn ruby_check_subcommand_spec_l333_d39_stops(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l343_d40_stops(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l351_d41_stops(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l359_d42_stops(args ...ruby.Value) ruby.Value {
	_ = args
	return check_spec_bool(check_spec_early_package('vscode', 'VSCode Extension'))
}

// Ruby it `it "raises an exception" do` at line 369.
pub fn ruby_check_subcommand_spec_l369_d43_raises(args ...ruby.Value) ruby.Value {
	_ = args
...
pub fn ruby_check_subcommand_spec_l371_d44_self_type(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.object_value('Symbol', 'test')
}

// Ruby method `self.check_label = "Test"` at line 372.
pub fn ruby_check_subcommand_spec_l372_d45_self_check_label(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.string_value('Test')
}

// Ruby method `self.reset!; end` at line 374.
pub fn ruby_check_subcommand_spec_l374_d46_self_reset(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.object_value('NilClass', '')
}

// Ruby method `self.preinstall!(name, no_upgrade: false, verbose: false, **options)` at line 376.
pub fn ruby_check_subcommand_spec_l376_d47_self_preinstall(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.object_value('NilClass', '')
}

// Ruby method `self.install!(name, preinstall: true, no_upgrade: false, verbose: false, force: false, **options)` at line 383.
pub fn ruby_check_subcommand_spec_l383_d48_self_install(args ...ruby.Value) ruby.Value {
	_ = args
	return ruby.object_value('NilClass', '')
}

// Ruby method `self.dump` at line 392.
pub fn ruby_check_subcommand_spec_l392_d49_self_dump(args ...ruby.Value) ruby.Value {
	_ = args
