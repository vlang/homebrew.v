...
pub fn ruby_denylist_spec_l8_d1_disallow(args ...ruby.Value) ruby.Value {
...
pub fn ruby_denylist_spec_l14_d2_aggregate_failures(args ...ruby.Value) ruby.Value {
	disallowed := ['adobe-after-effects', 'adobe-illustrator', 'adobe-indesign', 'adobe-photoshop',
		'adobe-premiere', 'pharo']
	return ruby.bool_value(brew_cask.denylist_reason('adobe-air') == none
