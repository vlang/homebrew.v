...
pub fn ruby_sandbox_l47_d1_allow_write_temp_and_cache(mut value homebrew.Sandbox) ! {
	homebrew.sandbox_allow_write_path(mut value, '/private/tmp')!
	homebrew.sandbox_allow_write_path(mut value, '/private/var/tmp')!
	homebrew.sandbox_allow_write(mut value, '^/private/var/folders/[^/]+/[^/]+/[C,T]/', .regex)!
	homebrew.sandbox_allow_write_temp_and_cache(mut value)!
}
...
pub fn ruby_sandbox_l56_d2_allow_write_xcode(mut value homebrew.Sandbox, user_home string) ! {
	for path in sandbox_home_write_paths(user_home) {
...
pub fn ruby_sandbox_l101_d7_sandbox_command(value homebrew.Sandbox, args []string, tmpdir string, sandbox_exec string) ![]string {
	...
	os.write_file(seatbelt_path, sandbox_seatbelt_profile(value.profile))!
