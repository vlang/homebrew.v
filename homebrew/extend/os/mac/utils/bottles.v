...
pub fn ruby_bottles_l27_d2_find_matching_tag(args ...ruby.Value) ruby.Value {
	...
	no_older_versions := args.len > 2 && args[2].type_name == 'Bool' && args[2].bool_data
	context := if args.len > 3 {
		mac_bottles_context_from_value(args[3])
	} else {
		MacBottlesMatchContext{}
	}
	return mac_bottles_find_matching_tag(args[0], args[1], no_older_versions, context) or {
		mac_bottles_nil_value()
	}
}
...
pub fn ruby_bottles_l43_d3_find_older_compatible_tag(args ...ruby.Value) ruby.Value {
	...
	return mac_bottles_find_older_compatible_tag(args[0], args[1]) or {
		mac_bottles_nil_value()
	}
}
