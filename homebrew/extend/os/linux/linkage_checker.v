...
pub fn ruby_linkage_checker_l39_d1_check_dylibs(state LinuxLinkageState,
	rebuild_cache bool) LinuxLinkageResult {
	return check_linux_dylibs(state, rebuild_cache)
}
