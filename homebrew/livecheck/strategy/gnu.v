...
pub fn ruby_gnu_l48_d1_self_match(args ...ruby.Value) ruby.Value {
	if args.len == 0 {
		return ruby.bool_value(false)
	}
	return ruby.bool_value(gnu_matches_url(args[0].as_string()))
}

// Ruby method `self.generate_input_values(url)` at line 60.
pub fn ruby_gnu_l60_d2_self_generate_input_values(args ...ruby.Value) ruby.Value {
	if args.len == 0 {
...
pub fn ruby_gnu_l101_d3_self_find_versions(args ...ruby.Value) ruby.Value {
	if args.len == 0 {
		return ruby.map_value({})
	}
	...
	result := gnu_find_versions(GnuFindRequest{
		...
		content: content
	}, gnu_empty_fetcher) or { return ruby.object_value('Error', err.msg()) }
