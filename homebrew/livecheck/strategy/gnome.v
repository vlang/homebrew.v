...
pub fn ruby_gnome_l44_d1_self_match(args ...ruby.Value) ruby.Value {
	if args.len == 0 {
		return ruby.bool_value(false)
	}
	return ruby.bool_value(gnome_matches_url(args[0].as_string()))
}

// Ruby method `self.generate_input_values(url)` at line 56.
pub fn ruby_gnome_l56_d2_self_generate_input_values(args ...ruby.Value) ruby.Value {
	if args.len == 0 {
...
pub fn ruby_gnome_l91_d3_self_find_versions(args ...ruby.Value) ruby.Value {
	if args.len == 0 {
		return ruby.map_value({})
	}
	...
	result := gnome_find_versions(GnomeFindRequest{
		...
		content: content
	}, gnome_empty_fetcher) or { return ruby.object_value('Error', err.msg()) }
