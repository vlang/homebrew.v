...
pub fn ruby_lua_rock_l10_d1_self_extensions(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.extensions', ...args)
}

// Ruby method `self.can_extract?(path)` at line 15.
pub fn ruby_lua_rock_l15_d2_self_can_extract(args ...brew_runtime.Value) brew_runtime.Value {
