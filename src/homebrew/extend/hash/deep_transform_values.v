...
pub fn ruby_deep_transform_values_l17_d1_deep_transform_values(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('deep_transform_values', ...args)
}

// Ruby method `_deep_transform_values_in_object(object, &block)` at line 23.
pub fn ruby_deep_transform_values_l23_d2_deep_transform_values_in_object(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('_deep_transform_values_in_object', ...args)
}

// Ruby method `_deep_transform_values_in_object!(object, &block)` at line 35.
pub fn ruby_deep_transform_values_l35_d3_deep_transform_values_in_object(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('_deep_transform_values_in_object!', ...args)
}
