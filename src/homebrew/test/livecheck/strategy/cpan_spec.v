...
pub fn ruby_cpan_spec_l7_d1_cpan(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('cpan', ...args)
}

// Ruby let `let(:cpan_urls) do` at line 9.
pub fn ruby_cpan_spec_l9_d2_cpan_urls(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('cpan_urls', ...args)
}

// Ruby let `let(:non_cpan_url) { "https://brew.sh/test" }` at line 17.
pub fn ruby_cpan_spec_l17_d3_non_cpan_url(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('non_cpan_url', ...args)
}

// Ruby let `let(:generated) do` at line 18.
pub fn ruby_cpan_spec_l18_d4_generated(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('generated', ...args)
}

// Ruby let `let(:content) do` at line 31.
pub fn ruby_cpan_spec_l31_d5_content(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('content', ...args)
}

// Ruby let `let(:matches) { ["1.2.3", "1.2.2", "1.2.1"] }` at line 59.
pub fn ruby_cpan_spec_l59_d6_matches(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('matches', ...args)
}

// Ruby it `it "returns true for a CPAN URL" do` at line 62.
pub fn ruby_cpan_spec_l62_d7_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('returns', ...args)
}

// Ruby it `it "returns false for a non-CPAN URL" do` at line 69.
pub fn ruby_cpan_spec_l69_d8_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('returns', ...args)
}

// Ruby it `it "returns a hash containing url and regex for a CPAN URL" do` at line 75.
pub fn ruby_cpan_spec_l75_d9_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('returns', ...args)
}

// Ruby it `it "returns an empty hash for a non-CPAN URL" do` at line 82.
pub fn ruby_cpan_spec_l82_d10_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('returns', ...args)
}

// Ruby let `let(:match_data) do` at line 88.
pub fn ruby_cpan_spec_l88_d11_match_data(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('match_data', ...args)
}

// Ruby it `it "finds versions in provided content" do` at line 102.
pub fn ruby_cpan_spec_l102_d12_finds(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_cpan_spec_l113_d13_returns(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('returns', ...args)
}
