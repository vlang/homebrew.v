...
pub fn ruby_osv_export_spec_l7_d1_now(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('now', ...args)
}

// Ruby let `let(:nvi) do` at line 9.
pub fn ruby_osv_export_spec_l9_d2_nvi(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('nvi', ...args)
}

// Ruby let `let(:libquicktime) do` at line 28.
pub fn ruby_osv_export_spec_l28_d3_libquicktime(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l42_d4_builds(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('builds', ...args)
}

// Ruby it `it "populates affected package and range" do` at line 55.
pub fn ruby_osv_export_spec_l55_d5_populates(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l64_d6_lists(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l77_d7_emits(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l99_d8_reads(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l110_d9_merges(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l128_d10_deduplicates(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l147_d11_percent_encodes(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('percent-encodes', ...args)
}

// Ruby it `it "percent-encodes + in the purl" do` at line 164.
pub fn ruby_osv_export_spec_l164_d12_percent_encodes(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('percent-encodes', ...args)
}

// Ruby it `it "uses an explicit fixed boundary over the current pkg_version" do` at line 181.
pub fn ruby_osv_export_spec_l181_d13_uses(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('uses', ...args)
}

// Ruby it `it "omits the revision suffix when revision is zero" do` at line 188.
pub fn ruby_osv_export_spec_l188_d14_omits(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('omits', ...args)
}

// Ruby it `it "writes one file per (formula, CVE) pair" do` at line 206.
pub fn ruby_osv_export_spec_l206_d15_writes(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l225_d16_calls(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l245_d17_falls(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l256_d18_fetches(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('fetches', ...args)
}

// Ruby let `let(:earlier) { Time.utc(2026, 6, 1, 0, 0, 0) }` at line 272.
pub fn ruby_osv_export_spec_l272_d19_earlier(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('earlier', ...args)
}

// Ruby let `let(:nvi_bumped) do` at line 273.
pub fn ruby_osv_export_spec_l273_d20_nvi_bumped(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('nvi_bumped', ...args)
}

// Ruby method `seed(dir, formula)` at line 293.
pub fn ruby_osv_export_spec_l293_d21_seed(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l297_d22_preserves(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('preserves', ...args)
}

// Ruby it `it "does not rewrite when nothing has changed" do` at line 310.
pub fn ruby_osv_export_spec_l310_d23_does(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('does', ...args)
}

// Ruby it `it "updates modified when refreshed upstream data differs" do` at line 322.
pub fn ruby_osv_export_spec_l322_d24_updates(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l338_d25_leaves(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_osv_export_spec_l354_d26_backfills(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('backfills', ...args)
}

// Ruby it `it "does not rewrite when the existing file has a different key order" do` at line 369.
pub fn ruby_osv_export_spec_l369_d27_does(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('does', ...args)
}

// Ruby it `it "leaves other files in the directory untouched" do` at line 384.
pub fn ruby_osv_export_spec_l384_d28_leaves(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('leaves', ...args)
}

// Ruby it `it "still writes a record when the upstream fetch fails" do` at line 400.
pub fn ruby_osv_export_spec_l400_d29_still(args ...brew_runtime.Value) brew_runtime.Value {
