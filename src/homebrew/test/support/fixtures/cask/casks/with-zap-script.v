...
// Translated from Homebrew/brew `test/support/fixtures/cask/Casks/with-zap-script.rb`.
// The original source is retained below until every stub has a typed V body.

// Original Ruby source (line-for-line):
// 1: # typed: false
// 2:
// 3: cask "with-zap-script" do
// 4:   version "1.2.3"
...
// 11:
// 12:   zap script: { executable: "MyFancyPkg/FancyUninstaller.tool", args: ["--please"] }
// 13: end
