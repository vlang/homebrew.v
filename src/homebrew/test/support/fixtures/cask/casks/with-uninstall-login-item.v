...
// Translated from Homebrew/brew `test/support/fixtures/cask/Casks/with-uninstall-login-item.rb`.
// The original source is retained below until every stub has a typed V body.

// Original Ruby source (line-for-line):
// 1: # typed: false
// 2:
// 3: cask "with-uninstall-login-item" do
// 4:   version "1.2.3"
