...
// Translated from Homebrew/brew `test/support/fixtures/cask/Casks/with-uninstall-both-on-upgrade.rb`.
// The original source is retained below until every stub has a typed V body.

// Original Ruby source (line-for-line):
// 1: # typed: false
// 2:
// 3: cask "with-uninstall-both-on-upgrade" do
// 4:   version "1.2.3"
...
// 13:             signal:     [["TERM", "my.fancy.package.app"]],
// 14:             on_upgrade: :signal
// 15: end
