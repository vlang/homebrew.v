...
pub fn ruby_deprecate_disable_unsigned_reason_spec_l7_d1_flags(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('flags', ...args)
}

// Ruby it `it "flags and autocorrects disable! with :unsigned" do` at line 22.
pub fn ruby_deprecate_disable_unsigned_reason_spec_l22_d2_flags(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('flags', ...args)
}

// Ruby it `it "ignores other reasons" do` at line 37.
pub fn ruby_deprecate_disable_unsigned_reason_spec_l37_d3_ignores(args ...brew_runtime.Value) brew_runtime.Value {
