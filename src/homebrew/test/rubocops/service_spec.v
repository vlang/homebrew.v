...
pub fn ruby_service_spec_l9_d2_reports(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('reports', ...args)
}

// Ruby it `it "reports no offenses when a service block includes custom names and requires root" do` at line 23.
pub fn ruby_service_spec_l23_d3_reports(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('reports', ...args)
}

// Ruby it `it "reports offenses when a service block includes more than custom names and no run command" do` at line 36.
pub fn ruby_service_spec_l36_d4_reports(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('reports', ...args)
}

// Ruby it `it "reports offenses when a formula's service block uses cellar paths" do` at line 50.
pub fn ruby_service_spec_l50_d5_reports(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('reports', ...args)
}

// Ruby it `it "reports no offenses when a service block only uses opt paths" do` at line 76.
pub fn ruby_service_spec_l76_d6_reports(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('reports', ...args)
}
