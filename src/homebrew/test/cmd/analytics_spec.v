...
pub fn ruby_analytics_spec_l10_d1_uses(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('uses', ...args)
}

// Ruby it `it "rejects extra arguments for state" do` at line 14.
pub fn ruby_analytics_spec_l14_d2_rejects(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_analytics_spec_l19_d3_when(args ...brew_runtime.Value) brew_runtime.Value {
