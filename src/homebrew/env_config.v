...
pub fn ruby_env_config_l801_d1_env_method_name(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('env_method_name', ...args)
}

// Ruby method `hidden?(hash)` at line 810.
pub fn ruby_env_config_l810_d2_hidden(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('hidden?', ...args)
}

// Ruby method `default_description(env)` at line 817.
pub fn ruby_env_config_l817_d3_default_description(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('default_description', ...args)
}

// Ruby method `non_default_variable?(env)` at line 848.
pub fn ruby_env_config_l848_d4_non_default_variable(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('non_default_variable?', ...args)
}

// Ruby method `user_set_variable?(env)` at line 868.
pub fn ruby_env_config_l868_d5_user_set_variable(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('user_set_variable?', ...args)
}

// Ruby method `non_default_variables` at line 876.
pub fn ruby_env_config_l876_d6_non_default_variables(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('non_default_variables', ...args)
}

// Ruby define_method `define_method(method_name) do` at line 891.
pub fn ruby_env_config_l891_d7_method_name(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('method_name', ...args)
}

// Ruby define_method `define_method(method_name) do` at line 903.
pub fn ruby_env_config_l903_d8_method_name(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('method_name', ...args)
}

// Ruby define_method `define_method(method_name) do` at line 912.
pub fn ruby_env_config_l912_d9_method_name(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('method_name', ...args)
}

// Ruby method `env_value(env, hash)` at line 919.
pub fn ruby_env_config_l919_d10_env_value(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('env_value', ...args)
}

// Ruby method `odeprecated_env(env, hash)` at line 934.
pub fn ruby_env_config_l934_d11_odeprecated_env(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('odeprecated_env', ...args)
}

// Ruby method `env_deprecation_applies?(hash)` at line 946.
pub fn ruby_env_config_l946_d12_env_deprecation_applies(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('env_deprecation_applies?', ...args)
}

// Ruby method `bottle_domain_custom?` at line 959.
pub fn ruby_env_config_l959_d13_bottle_domain_custom(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('bottle_domain_custom?', ...args)
}

// Ruby method `make_jobs` at line 964.
pub fn ruby_env_config_l964_d14_make_jobs(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('make_jobs', ...args)
}

// Ruby method `cask_opts` at line 975.
pub fn ruby_env_config_l975_d15_cask_opts(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('cask_opts', ...args)
}

// Ruby method `self.cask_opts_binaries?` at line 980.
pub fn ruby_env_config_l980_d16_self_cask_opts_binaries(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.cask_opts_binaries?', ...args)
}

// Ruby method `cask_opts_require_sha?` at line 994.
pub fn ruby_env_config_l994_d17_cask_opts_require_sha(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('cask_opts_require_sha?', ...args)
}

// Ruby method `bundle_jobs` at line 1003.
pub fn ruby_env_config_l1003_d18_bundle_jobs(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('bundle_jobs', ...args)
}

// Ruby method `forbid_packages_from_paths?` at line 1016.
pub fn ruby_env_config_l1016_d19_forbid_packages_from_paths(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('forbid_packages_from_paths?', ...args)
}

// Ruby method `automatically_set_no_install_from_api?` at line 1029.
pub fn ruby_env_config_l1029_d20_automatically_set_no_install_from_api(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('automatically_set_no_install_from_api?', ...args)
}

// Ruby method `devcmdrun?` at line 1034.
pub fn ruby_env_config_l1034_d21_devcmdrun(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('devcmdrun?', ...args)
}

// Ruby method `download_concurrency` at line 1039.
pub fn ruby_env_config_l1039_d22_download_concurrency(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('download_concurrency', ...args)
}

// Ruby method `tap_trust_configured?` at line 1053.
pub fn ruby_env_config_l1053_d23_tap_trust_configured(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('tap_trust_configured?', ...args)
}
