...
pub fn ruby_formulary_l38_d1_self_enable_factory_cache(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.enable_factory_cache!', ...args)
}

// Ruby method `self.factory_cached?` at line 45.
pub fn ruby_formulary_l45_d2_self_factory_cached(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.factory_cached?', ...args)
}

// Ruby method `self.platform_cache_tag` at line 50.
pub fn ruby_formulary_l50_d3_self_platform_cache_tag(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.platform_cache_tag', ...args)
}

// Ruby method `self.platform_cache` at line 62.
pub fn ruby_formulary_l62_d4_self_platform_cache(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.platform_cache', ...args)
}

// Ruby method `self.factory_cache` at line 67.
pub fn ruby_formulary_l67_d5_self_factory_cache(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.factory_cache', ...args)
}

// Ruby method `self.formula_class_defined_from_path?(path)` at line 73.
pub fn ruby_formulary_l73_d6_self_formula_class_defined_from_path(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.formula_class_defined_from_path?', ...args)
}

// Ruby method `self.formula_class_defined_from_api?(name)` at line 78.
pub fn ruby_formulary_l78_d7_self_formula_class_defined_from_api(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.formula_class_defined_from_api?', ...args)
}

// Ruby method `self.formula_class_get_from_path(path)` at line 83.
pub fn ruby_formulary_l83_d8_self_formula_class_get_from_path(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.formula_class_get_from_path', ...args)
}

// Ruby method `self.formula_class_get_from_api(name)` at line 88.
pub fn ruby_formulary_l88_d9_self_formula_class_get_from_api(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.formula_class_get_from_api', ...args)
}

// Ruby method `self.clear_cache` at line 93.
pub fn ruby_formulary_l93_d10_self_clear_cache(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.clear_cache', ...args)
}

// Ruby method `self.load_formula(name, path, contents, namespace, flags:, ignore_errors:)` at line 123.
pub fn ruby_formulary_l123_d11_self_load_formula(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.load_formula', ...args)
}

// Ruby method `self.namespace_key(identifier)` at line 193.
pub fn ruby_formulary_l193_d12_self_namespace_key(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.namespace_key', ...args)
}

// Ruby method `self.replace_placeholders(string)` at line 200.
pub fn ruby_formulary_l200_d13_self_replace_placeholders(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_formulary_l210_d14_self_load_formula_from_path(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.load_formula_from_path', ...args)
}
...
pub fn ruby_formulary_l228_d15_self_load_formula_from_struct(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.load_formula_from_struct!', ...args)
}

// Ruby define_method `define_method(:install) do` at line 343.
pub fn ruby_formulary_l343_d16_install(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('install', ...args)
}

// Ruby define_method `define_method(:post_install_defined?) do` at line 348.
pub fn ruby_formulary_l348_d17_post_install_defined(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('post_install_defined?', ...args)
}

// Ruby define_method `define_method(:caveats) do` at line 364.
pub fn ruby_formulary_l364_d18_caveats(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('caveats', ...args)
}

// Ruby define_method `define_method(:tap_git_head) do` at line 369.
pub fn ruby_formulary_l369_d19_tap_git_head(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('tap_git_head', ...args)
}

// Ruby define_method `define_method(:oldnames) do` at line 374.
pub fn ruby_formulary_l374_d20_oldnames(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('oldnames', ...args)
}

// Ruby define_method `define_method(:aliases) do` at line 379.
pub fn ruby_formulary_l379_d21_aliases(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_formulary_l384_d22_versioned_formulae_names(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('versioned_formulae_names', ...args)
}

// Ruby define_method `define_method(:ruby_source_path) do` at line 389.
pub fn ruby_formulary_l389_d23_ruby_source_path(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('ruby_source_path', ...args)
}

// Ruby define_method `define_method(:ruby_source_checksum) do` at line 394.
pub fn ruby_formulary_l394_d24_ruby_source_checksum(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('ruby_source_checksum', ...args)
}

// Ruby method `self.resolve(` at line 409.
pub fn ruby_formulary_l409_d25_self_resolve(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.resolve', ...args)
}

// Ruby method `self.ensure_utf8_encoding(io)` at line 447.
pub fn ruby_formulary_l447_d26_self_ensure_utf8_encoding(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.ensure_utf8_encoding', ...args)
}

// Ruby method `self.class_s(name)` at line 452.
pub fn ruby_formulary_l452_d27_self_class_s(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.class_s', ...args)
}

// Ruby attr_reader `attr_reader :name` at line 468.
pub fn ruby_formulary_l468_d28_name(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('name', ...args)
}

// Ruby attr_reader `attr_reader :path` at line 472.
pub fn ruby_formulary_l472_d29_path(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('path', ...args)
}

// Ruby attr_reader `attr_reader :alias_path` at line 476.
pub fn ruby_formulary_l476_d30_alias_path(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('alias_path', ...args)
}

// Ruby attr_reader `attr_reader :tap` at line 480.
pub fn ruby_formulary_l480_d31_tap(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('tap', ...args)
}

// Ruby method `initialize(name, path, alias_path: nil, tap: nil)` at line 485.
pub fn ruby_formulary_l485_d32_initialize(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('initialize', ...args)
}

// Ruby method `get_formula(spec, alias_path: nil, force_bottle: false, flags: [], ignore_errors: false)` at line 504.
pub fn ruby_formulary_l504_d33_get_formula(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('get_formula', ...args)
}

// Ruby method `klass(flags:, ignore_errors:)` at line 512.
pub fn ruby_formulary_l512_d34_klass(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('klass', ...args)
}

// Ruby method `load_file(flags:, ignore_errors:)` at line 520.
pub fn ruby_formulary_l520_d35_load_file(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('load_file', ...args)
}

// Ruby method `self.try_new(ref, from: nil, warn: false)` at line 535.
pub fn ruby_formulary_l535_d36_self_try_new(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.try_new', ...args)
}

// Ruby method `initialize(bottle_name, warn: false)` at line 544.
pub fn ruby_formulary_l544_d37_initialize(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('initialize', ...args)
}

// Ruby method `get_formula(spec, alias_path: nil, force_bottle: false, flags: [], ignore_errors: false)` at line 571.
pub fn ruby_formulary_l571_d38_get_formula(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('get_formula', ...args)
}

// Ruby method `self.try_new(ref, from: nil, warn: false)` at line 600.
pub fn ruby_formulary_l600_d39_self_try_new(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.try_new', ...args)
}

// Ruby method `initialize(path, alias_path: nil, tap: nil)` at line 630.
pub fn ruby_formulary_l630_d40_initialize(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('initialize', ...args)
}

// Ruby method `self.try_new(ref, from: nil, warn: false)` at line 648.
pub fn ruby_formulary_l648_d41_self_try_new(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.try_new', ...args)
}

// Ruby attr_reader `attr_reader :url` at line 668.
pub fn ruby_formulary_l668_d42_url(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('url', ...args)
}

// Ruby method `initialize(url, from: nil)` at line 671.
pub fn ruby_formulary_l671_d43_initialize(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('initialize', ...args)
}

// Ruby method `load_file(flags:, ignore_errors:)` at line 682.
pub fn ruby_formulary_l682_d44_load_file(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('load_file', ...args)
}

// Ruby attr_reader `attr_reader :tap` at line 705.
pub fn ruby_formulary_l705_d45_tap(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('tap', ...args)
}

// Ruby attr_reader `attr_reader :path` at line 708.
pub fn ruby_formulary_l708_d46_path(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('path', ...args)
}

// Ruby method `self.try_new(ref, from: nil, warn: false)` at line 714.
pub fn ruby_formulary_l714_d47_self_try_new(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.try_new', ...args)
}

// Ruby method `self.loader_from_name_tap_type(name_tap_type)` at line 726.
pub fn ruby_formulary_l726_d48_self_loader_from_name_tap_type(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.loader_from_name_tap_type', ...args)
}

// Ruby method `initialize(name, path, tap:, alias_name: nil)` at line 738.
pub fn ruby_formulary_l738_d49_initialize(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('initialize', ...args)
}

// Ruby method `get_formula(spec, alias_path: nil, force_bottle: false, flags: [], ignore_errors: false)` at line 754.
pub fn ruby_formulary_l754_d50_get_formula(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('get_formula', ...args)
}

// Ruby method `load_file(flags:, ignore_errors:)` at line 765.
pub fn ruby_formulary_l765_d51_load_file(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('load_file', ...args)
}

// Ruby method `self.try_new(ref, from: nil, warn: false)` at line 781.
pub fn ruby_formulary_l781_d52_self_try_new(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.try_new', ...args)
}

// Ruby method `self.try_new(ref, from: nil, warn: false)` at line 824.
pub fn ruby_formulary_l824_d53_self_try_new(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.try_new', ...args)
}

// Ruby method `self.try_new(ref, from: nil, warn: false)` at line 845.
pub fn ruby_formulary_l845_d54_self_try_new(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.try_new', ...args)
}

// Ruby method `self.try_new(ref, from: nil, warn: false)` at line 860.
pub fn ruby_formulary_l860_d55_self_try_new(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.try_new', ...args)
}

// Ruby method `initialize(ref)` at line 867.
pub fn ruby_formulary_l867_d56_initialize(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('initialize', ...args)
}

// Ruby method `get_formula(_spec, alias_path: nil, force_bottle: false, flags: [], ignore_errors: false)` at line 881.
pub fn ruby_formulary_l881_d57_get_formula(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('get_formula', ...args)
}

// Ruby attr_reader `attr_reader :contents` at line 890.
pub fn ruby_formulary_l890_d58_contents(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('contents', ...args)
}

// Ruby method `initialize(name, path, contents, tap: nil)` at line 893.
pub fn ruby_formulary_l893_d59_initialize(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('initialize', ...args)
}

// Ruby method `klass(flags:, ignore_errors:)` at line 899.
pub fn ruby_formulary_l899_d60_klass(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('klass', ...args)
}

// Ruby method `self.try_new(ref, from: nil, warn: false)` at line 911.
pub fn ruby_formulary_l911_d61_self_try_new(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.try_new', ...args)
}

// Ruby method `initialize(name, tap: nil, alias_name: nil)` at line 931.
pub fn ruby_formulary_l931_d62_initialize(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('initialize', ...args)
}

// Ruby method `klass(flags:, ignore_errors:)` at line 938.
pub fn ruby_formulary_l938_d63_klass(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('klass', ...args)
}

// Ruby method `load_from_api(flags:)` at line 946.
pub fn ruby_formulary_l946_d64_load_from_api(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('load_from_api', ...args)
}

// Ruby method `initialize(name, contents, tap: nil, alias_name: nil)` at line 961.
pub fn ruby_formulary_l961_d65_initialize(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('initialize', ...args)
}

// Ruby method `load_from_api(flags:)` at line 969.
pub fn ruby_formulary_l969_d66_load_from_api(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('load_from_api', ...args)
}

// Ruby method `self.factory(` at line 997.
pub fn ruby_formulary_l997_d67_self_factory(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.factory', ...args)
}
...
pub fn ruby_formulary_l1035_d68_self_from_rack(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.from_rack', ...args)
}
...
pub fn ruby_formulary_l1051_d69_self_keg_only(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.keg_only?', ...args)
}
...
pub fn ruby_formulary_l1068_d70_self_from_keg(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.from_keg', ...args)
}

// Ruby method `self.from_contents(` at line 1119.
pub fn ruby_formulary_l1119_d71_self_from_contents(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.from_contents', ...args)
}
...
pub fn ruby_formulary_l1135_d72_self_to_rack(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.to_rack', ...args)
}

// Ruby method `self.canonical_name(ref)` at line 1156.
pub fn ruby_formulary_l1156_d73_self_canonical_name(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.canonical_name', ...args)
}

// Ruby method `self.path(ref)` at line 1165.
pub fn ruby_formulary_l1165_d74_self_path(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.path', ...args)
}

// Ruby method `self.tap_formula_name_type(tapped_name, warn:)` at line 1173.
pub fn ruby_formulary_l1173_d75_self_tap_formula_name_type(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.tap_formula_name_type', ...args)
}

// Ruby method `self.loader_for(ref, from: nil, warn: true)` at line 1230.
pub fn ruby_formulary_l1230_d76_self_loader_for(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.loader_for', ...args)
}

// Ruby method `self.core_path(name)` at line 1251.
pub fn ruby_formulary_l1251_d77_self_core_path(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.core_path', ...args)
}

// Ruby method `self.find_formula_in_tap(name, tap)` at line 1256.
pub fn ruby_formulary_l1256_d78_self_find_formula_in_tap(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.find_formula_in_tap', ...args)
}
