...
pub fn ruby_github_l23_d1_self_issues(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.issues', ...args)
}

// Ruby method `self.search_issues(query, **qualifiers)` at line 30.
pub fn ruby_github_l30_d2_self_search_issues(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.search_issues', ...args)
}

// Ruby method `self.create_gist(files, description, private:)` at line 36.
pub fn ruby_github_l36_d3_self_create_gist(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.create_gist', ...args)
}

// Ruby method `self.create_issue(repo, title, body)` at line 43.
pub fn ruby_github_l43_d4_self_create_issue(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.create_issue', ...args)
}

// Ruby method `self.create_issue_comment(repo, issue, body)` at line 50.
pub fn ruby_github_l50_d5_self_create_issue_comment(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.create_issue_comment', ...args)
}

// Ruby method `self.repository(user, repo)` at line 56.
pub fn ruby_github_l56_d6_self_repository(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.repository', ...args)
}
...
pub fn ruby_github_l69_d7_self_issues_for_formula(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.issues_for_formula', ...args)
}

// Ruby method `self.user` at line 76.
pub fn ruby_github_l76_d8_self_user(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_github_l81_d9_self_print_pull_requests_matching(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.print_pull_requests_matching', ...args)
}

// Ruby method `self.create_fork(repo, org: nil)` at line 105.
pub fn ruby_github_l105_d10_self_create_fork(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.create_fork', ...args)
}

// Ruby method `self.fork_exists?(repo, org: nil)` at line 114.
pub fn ruby_github_l114_d11_self_fork_exists(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.fork_exists?', ...args)
}

// Ruby method `self.create_pull_request(repo, title, head, base, body)` at line 126.
pub fn ruby_github_l126_d12_self_create_pull_request(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.create_pull_request', ...args)
}

// Ruby method `self.private_repo?(full_name)` at line 135.
pub fn ruby_github_l135_d13_self_private_repo(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.private_repo?', ...args)
}

// Ruby method `self.search_query_string(*main_params, **qualifiers)` at line 141.
pub fn ruby_github_l141_d14_self_search_query_string(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.search_query_string', ...args)
}

// Ruby method `self.url_to(*subroutes)` at line 163.
pub fn ruby_github_l163_d15_self_url_to(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.url_to', ...args)
}

// Ruby method `self.search(entity, *queries, **qualifiers)` at line 168.
pub fn ruby_github_l168_d16_self_search(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_github_l178_d17_self_repository_approved_reviews(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.repository_approved_reviews', ...args)
}

// Ruby method `self.workflow_dispatch_event(user, repo, workflow, ref, **inputs)` at line 220.
pub fn ruby_github_l220_d18_self_workflow_dispatch_event(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.workflow_dispatch_event', ...args)
}

// Ruby method `self.get_release(user, repo, tag)` at line 228.
pub fn ruby_github_l228_d19_self_get_release(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.get_release', ...args)
}

// Ruby method `self.get_latest_release(user, repo)` at line 234.
pub fn ruby_github_l234_d20_self_get_latest_release(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.get_latest_release', ...args)
}

// Ruby method `self.generate_release_notes(user, repo, tag, previous_tag: nil)` at line 240.
pub fn ruby_github_l240_d21_self_generate_release_notes(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.generate_release_notes', ...args)
}

// Ruby method `self.create_or_update_release(user, repo, tag, id: nil, name: nil, body: nil, draft: false)` at line 251.
pub fn ruby_github_l251_d22_self_create_or_update_release(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.create_or_update_release', ...args)
}

// Ruby method `self.upload_release_asset(user, repo, id, local_file:, remote_file: nil)` at line 271.
pub fn ruby_github_l271_d23_self_upload_release_asset(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.upload_release_asset', ...args)
}

// Ruby method `self.get_workflow_run(user, repo, pull_request, workflow_id: "tests.yml", artifact_pattern: "bottles{,_*}",` at line 287.
pub fn ruby_github_l287_d24_self_get_workflow_run(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.get_workflow_run', ...args)
}

// Ruby method `self.get_artifact_urls(workflow_array)` at line 348.
pub fn ruby_github_l348_d25_self_get_artifact_urls(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.get_artifact_urls', ...args)
}

// Ruby method `self.members_by_team(org, team)` at line 394.
pub fn ruby_github_l394_d26_self_members_by_team(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.members_by_team', ...args)
}

// Ruby method `self.sponsorships(user)` at line 434.
pub fn ruby_github_l434_d27_self_sponsorships(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.sponsorships', ...args)
}

// Ruby method `self.get_repo_license(user, repo, ref: nil)` at line 500.
pub fn ruby_github_l500_d28_self_get_repo_license(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.get_repo_license', ...args)
}

// Ruby method `self.pull_request_title_regex(name, version = nil)` at line 514.
pub fn ruby_github_l514_d29_self_pull_request_title_regex(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.pull_request_title_regex', ...args)
}

// Ruby method `self.fetch_pull_requests(name, tap_remote_repo, state: nil, version: nil)` at line 524.
pub fn ruby_github_l524_d30_self_fetch_pull_requests(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.fetch_pull_requests', ...args)
}

// Ruby method `self.fetch_open_pull_requests(name, tap_remote_repo, version: nil)` at line 587.
pub fn ruby_github_l587_d31_self_fetch_open_pull_requests(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.fetch_open_pull_requests', ...args)
}

// Ruby method `self.check_for_duplicate_pull_requests(name, tap_remote_repo, file:, quiet: false, state: nil,` at line 652.
pub fn ruby_github_l652_d32_self_check_for_duplicate_pull_requests(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.check_for_duplicate_pull_requests', ...args)
}

// Ruby method `self.get_pull_request_changed_files(tap_remote_repo, pull_request)` at line 691.
pub fn ruby_github_l691_d33_self_get_pull_request_changed_files(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.get_pull_request_changed_files', ...args)
}

// Ruby method `self.pull_request_commits(user, repo, pull_request, per_page: MAX_PER_PAGE)` at line 703.
pub fn ruby_github_l703_d34_self_pull_request_commits(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.pull_request_commits', ...args)
}

// Ruby method `self.pull_request_labels(user, repo, pull_request)` at line 727.
pub fn ruby_github_l727_d35_self_pull_request_labels(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.pull_request_labels', ...args)
}

// Ruby method `self.last_commit(user, repo, ref, version, length: nil)` at line 736.
pub fn ruby_github_l736_d36_self_last_commit(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.last_commit', ...args)
}

// Ruby method `self.multiple_short_commits_exist?(user, repo, commit)` at line 769.
pub fn ruby_github_l769_d37_self_multiple_short_commits_exist(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.multiple_short_commits_exist?', ...args)
}

// Ruby method `self.too_many_open_prs?(tap)` at line 793.
pub fn ruby_github_l793_d38_self_too_many_open_prs(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.too_many_open_prs?', ...args)
}

// Ruby method `self.organisation_repositories(organisation, from, to, verbose)` at line 858.
pub fn ruby_github_l858_d39_self_organisation_repositories(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.organisation_repositories', ...args)
}

// Ruby method `self.search_approved_pull_requests_in_user_or_organisation(user, reviewed_by, from:, to:)` at line 898.
pub fn ruby_github_l898_d40_self_search_approved_pull_requests_in_user_or_organisation(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.search_approved_pull_requests_in_user_or_organisation',
		...args)
}
