...
pub fn ruby_download_queue_l23_d1_initialize(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('initialize', ...args)
}

// Ruby method `enqueue(downloadable, check_attestation: false, stage: pour)` at line 48.
pub fn ruby_download_queue_l48_d2_enqueue(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('enqueue', ...args)
}

// Ruby method `fetch(only: nil, heading: nil, allow_failures: false)` at line 119.
pub fn ruby_download_queue_l119_d3_fetch(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('fetch', ...args)
}

// Ruby attr_reader `attr_reader :failed_downloads` at line 314.
pub fn ruby_download_queue_l314_d4_failed_downloads(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('failed_downloads', ...args)
}

// Ruby method `stdout_print_and_flush_if_tty(message)` at line 317.
pub fn ruby_download_queue_l317_d5_stdout_print_and_flush_if_tty(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('stdout_print_and_flush_if_tty', ...args)
}

// Ruby method `stdout_print_and_flush(message)` at line 322.
pub fn ruby_download_queue_l322_d6_stdout_print_and_flush(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('stdout_print_and_flush', ...args)
}

// Ruby method `shutdown` at line 328.
pub fn ruby_download_queue_l328_d7_shutdown(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('shutdown', ...args)
}

// Ruby method `downloads` at line 334.
pub fn ruby_download_queue_l334_d8_downloads(args ...brew_runtime.Value) brew_runtime.Value {
...
pub fn ruby_download_queue_l341_d9_check_bottle_attestation(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('check_bottle_attestation', ...args)
}

// Ruby method `create_symlinks_for_shared_download(cached_location)` at line 349.
pub fn ruby_download_queue_l349_d10_create_symlinks_for_shared_download(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('create_symlinks_for_shared_download', ...args)
}

// Ruby method `bottle_manifest_error?(downloadable, exception)` at line 363.
pub fn ruby_download_queue_l363_d11_bottle_manifest_error(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('bottle_manifest_error?', ...args)
}

// Ruby method `report_or_defer_failure(&block)` at line 371.
pub fn ruby_download_queue_l371_d12_report_or_defer_failure(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('report_or_defer_failure', ...args)
}

// Ruby method `with_active_thread(&_block)` at line 380.
pub fn ruby_download_queue_l380_d13_with_active_thread(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('with_active_thread', ...args)
}

// Ruby method `cancel` at line 390.
pub fn ruby_download_queue_l390_d14_cancel(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('cancel', ...args)
}

// Ruby attr_reader `attr_reader :pool` at line 399.
pub fn ruby_download_queue_l399_d15_pool(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('pool', ...args)
}

// Ruby attr_reader `attr_reader :concurrency` at line 402.
pub fn ruby_download_queue_l402_d16_concurrency(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('concurrency', ...args)
}

// Ruby attr_reader `attr_reader :tries` at line 405.
pub fn ruby_download_queue_l405_d17_tries(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('tries', ...args)
}

// Ruby attr_reader `attr_reader :force` at line 408.
pub fn ruby_download_queue_l408_d18_force(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('force', ...args)
}

// Ruby attr_reader `attr_reader :quiet` at line 411.
pub fn ruby_download_queue_l411_d19_quiet(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('quiet', ...args)
}

// Ruby attr_reader `attr_reader :pour` at line 414.
pub fn ruby_download_queue_l414_d20_pour(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('pour', ...args)
}

// Ruby attr_reader `attr_reader :tty` at line 417.
pub fn ruby_download_queue_l417_d21_tty(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('tty', ...args)
}

// Ruby method `tty_with_cursor_move_support?` at line 420.
pub fn ruby_download_queue_l420_d22_tty_with_cursor_move_support(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('tty_with_cursor_move_support?', ...args)
}

// Ruby method `unlink_cached_download(downloadable)` at line 425.
pub fn ruby_download_queue_l425_d23_unlink_cached_download(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('unlink_cached_download', ...args)
}

// Ruby method `report_tolerated_failure(downloadable)` at line 433.
pub fn ruby_download_queue_l433_d24_report_tolerated_failure(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('report_tolerated_failure', ...args)
}

// Ruby method `status_from_future(future)` at line 443.
pub fn ruby_download_queue_l443_d25_status_from_future(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('status_from_future', ...args)
}

// Ruby method `align_checksum_mismatch_message(downloadable_type)` at line 465.
pub fn ruby_download_queue_l465_d26_align_checksum_mismatch_message(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('align_checksum_mismatch_message', ...args)
}

// Ruby method `spinner` at line 477.
pub fn ruby_download_queue_l477_d27_spinner(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('spinner', ...args)
}

// Ruby method `message_with_progress(downloadable, future, message, message_length_max)` at line 482.
pub fn ruby_download_queue_l482_d28_message_with_progress(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('message_with_progress', ...args)
}

// Ruby method `initialize` at line 541.
pub fn ruby_download_queue_l541_d29_initialize(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('initialize', ...args)
}

// Ruby method `to_s` at line 547.
pub fn ruby_download_queue_l547_d30_to_s(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('to_s', ...args)
}

// Ruby method `self.default_download_queue` at line 560.
pub fn ruby_download_queue_l560_d31_self_default_download_queue(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.default_download_queue', ...args)
}

// Ruby method `self.reset_default_download_queue` at line 565.
pub fn ruby_download_queue_l565_d32_self_reset_default_download_queue(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.reset_default_download_queue', ...args)
}

// Ruby method `self.shutdown_default_download_queue` at line 573.
pub fn ruby_download_queue_l573_d33_self_shutdown_default_download_queue(args ...brew_runtime.Value) brew_runtime.Value {
	return brew_runtime.unimplemented_fn('self.shutdown_default_download_queue', ...args)
}
